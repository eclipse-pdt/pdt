...
@header {
  ...
  import org.eclipse.php.internal.core.compiler.ast.parser.php5.ErrorNode;
...
//    
    ...
    ErrorNode nodeInfo = new ErrorNode();
  ...
  : ( class_entr_type? CLASS_T IDENTIFIER
  {
   ...
   (EXTENDS_T
      ...
      class_body
    {
      ...
      endIndex = $class_body.tree.endIndex;
    }
...
@after {
  ...
  : LEFT_BRACKET SEMI_COLON? case_list+ RIGHT_BRACKET           
  {
    ...
    ->  ^(BLOCK case_list+)
  | COLON_T SEMI_COLON? case_list+ ENDSWITCH_T SEMI_COLON
  {
    startIndex = ((CommonToken)$COLON_T).getStartIndex();
    token = (CommonToken)$case_list.stop;
    if (token != null) endIndex = token.getStopIndex();
  }  
    ->  ^(BLOCK case_list+)
  ;
