...
public class RenameGlobalConstantProcessorTest extends AbstractRenameRefactoringTest {
	...
	public RenameGlobalConstantProcessorTest(String fileName) {
		super(fileName);
	}
	...
	public List<TestCase> createTest() {
		...
		for (final String fileName : filesMap.keySet()) {
			...
			tests.add(new RenameGlobalConstantProcessorTest(fileName) {
				@Override
	...
	protected String getTestDirectory() {
		return "/resources/rename/renameGblConst/";
	}
