...
public class PHP55ErrorReportingTests extends AbstractPDTTTest {
	...
	public static void setUpSuite() throws Exception {
		...
		PHPCoreTests.setProjectPhpVersion(project, PHPVersion.PHP5_5);
	...
	public PHP55ErrorReportingTests(String description) {
		super(description);
	}

	public static Test suite() {

		TestSuite suite = new TestSuite("php55");
