...
public class PHP56ErrorReportingTests extends AbstractPDTTTest {
	...
	public static void setUpSuite() throws Exception {
		...
		PHPCoreTests.setProjectPhpVersion(project, PHPVersion.PHP5_6);
	...
	public PHP56ErrorReportingTests(String description) {
		super(description);
	}

	public static Test suite() {

		TestSuite suite = new TestSuite("php56");
		...
		for (String testsDirectory : TEST_DIRS) {
			...
			for (final String fileName : getPDTTFiles(testsDirectory)) {
				try {
					...
					suite.addTest(new PHP56ErrorReportingTests("/" + fileName) {
