...
public class PHP53ErrorReportingTests extends AbstractPDTTTest {

	protected static final String[] TEST_DIRS = { "/workspace/errors/php53" };
	...
	public static void setUpSuite() throws Exception {
		...
		PHPCoreTests.setProjectPhpVersion(project, PHPVersion.PHP5_3);
	...
	public PHP53ErrorReportingTests(String description) {
		super(description);
	}

	public static Test suite() {

		TestSuite suite = new TestSuite("php53");
