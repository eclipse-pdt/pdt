...
public class BracketInserterTests {
	...
	static {
		TESTS.put(PHPVersion.PHP5, new String[] { "/workspace/bracket-inserter" });
		TESTS.put(PHPVersion.PHP5_3, new String[] { "/workspace/bracket-inserter" });
		TESTS.put(PHPVersion.PHP5_6, new String[] { "/workspace/bracket-inserter" });
		TESTS.put(PHPVersion.PHP7_0, new String[] { "/workspace/bracket-inserter" });
