...
public class ContentAssistTests {
	...
	public void setUpSuite() throws Exception {
		DLTKUIPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.CODEASSIST_TIMEOUT, 60000);
	...
	public void tearDownSuite() throws Exception {
		...
		DLTKUIPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.CODEASSIST_TIMEOUT,
				DLTKUIPlugin.getDefault().getPreferenceStore().getDefaultInt(PreferenceConstants.CODEASSIST_TIMEOUT));
	}
