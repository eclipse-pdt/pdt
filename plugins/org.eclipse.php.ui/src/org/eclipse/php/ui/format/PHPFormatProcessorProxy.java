/*******************************************************************************
 * Copyright (c) 2009, 2010, 2019 Zend Technologies Ltd. and others.
 *
			...
			if (document != null) {
				...
				if (formatter instanceof IFormatterProcessorFactory) {
					...
					if (removeTrailingWhitespacesEnabled) {
						...
						Program astRoot = parser.createAST(new NullProgressMonitor());

						DeleteEdit[] deletes = FormatterUtils.getTrailingWhitespaces(document, astRoot,
								ignoreEmptyLines);
