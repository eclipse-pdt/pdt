...
//		fBreakContinueTargetOccurrencesAction.setActionDefinitionId(IJavaEditorActionDefinitionIds.SEARCH_BREAK_CONTINUE_TARGET_OCCURRENCES);
		...
		fMethodExitOccurrencesAction.setActionDefinitionId(IPHPEditorActionDefinitionIds.SEARCH_METHOD_EXIT_OCCURRENCES);
...
//				addAction(fBreakContinueTargetOccurrencesAction, mm);
	...
	private void updateActionsInPhpEditor() {
		...
		ModelTextSelection phpSelection= new ModelTextSelection(element, document, textSelection.getOffset(), textSelection.getLength());
...
//		fBreakContinueTargetOccurrencesAction.update(javaSelection);
	...
	private String getShortcutString() {
		...
		if (bindingService == null)
			return null;
		return bindingService.getBestActiveBindingFormattedFor(IPHPEditorActionDefinitionIds.SEARCH_OCCURRENCES_IN_FILE_QUICK_MENU);
	}
...
//			fActionBars.setGlobalActionHandler(JdtActionConstants.FIND_BREAK_CONTINUE_TARGET_OCCURRENCES, fBreakContinueTargetOccurrencesAction);
			fActionBars.setGlobalActionHandler(PHPActionConstants.FIND_METHOD_EXIT_OCCURRENCES, fMethodExitOccurrencesAction);
