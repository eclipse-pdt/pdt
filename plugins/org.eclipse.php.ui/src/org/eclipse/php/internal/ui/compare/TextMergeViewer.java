				...
				fCenterButton.addSelectionListener(new SelectionAdapter() {
					public void widgetSelected(SelectionEvent e) {
						...
						if (fButtonDiff != null) {
							...
							copy(fCurrentDiff, fCenterButton.getText().equals(COPY_LEFT_TO_RIGHT_INDICATOR), fCurrentDiff.fDirection != RangeDifference.CONFLICT);
						}
					}
				});
			} else {
...
//				
	...
	protected void createToolItems(ToolBarManager tbm) {
		...
		toggleLineNumbersAction = new TextEditorPropertyAction(CompareMessages.TextMergeViewer_16, new MergeSourceViewer[] { fLeft, fRight, fAncestor }, AbstractDecoratedTextEditorPreferenceConstants.EDITOR_LINE_NUMBER_RULER);
