...
public class WorkingSetConfigurationDialog extends SelectionDialog {
	...
	private static class Filter extends ViewerFilter {
		public boolean select(Viewer viewer, Object parentElement, Object element) {
			...
			String id = ws.getId();
			return HistoryWorkingSetUpdater.ID.equals(id) || OthersWorkingSetUpdater.ID.equals(id) || PHPWorkingSetUpdater.ID.equals(id);
		}
	}
	...
	private void createWorkingSet() {
		...
		IWorkingSetNewWizard wizard = manager.createWorkingSetNewWizard(new String[] { PHPWorkingSetUpdater.ID });
		// the wizard can't be null since we have at least the php working set.
