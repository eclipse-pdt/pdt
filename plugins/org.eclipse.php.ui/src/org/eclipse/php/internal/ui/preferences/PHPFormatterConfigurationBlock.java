...
/**
 * @author guy.g
 * @deprecated Formatter configuration block is now provided by
 *             org.eclipse.php.formatter
 *             .ui.preferences.CodeFormatterConfigurationBlock
 */
public class PHPFormatterConfigurationBlock extends PHPCoreOptionsConfigurationBlock
	...
	public static final Key PREF_FORMATTER_INDENTATION_SIZE = getPHPCoreKey(
	...
	public static final Key PREF_FORMATTER_INDENTATION_WRAPPED_LINE_SIZE = getPHPCoreKey(
			PHPCoreConstants.FORMATTER_INDENTATION_WRAPPED_LINE_SIZE);
	public static final Key PREF_FORMATTER_INDENTATION_ARRAY_INIT_SIZE = getPHPCoreKey(
	...
	public PHPFormatterConfigurationBlock(IStatusChangeListener context, IProject project,
	...
	private static Key[] getKeys() {
		return new Key[] { PREF_FORMATTER_USE_TABS, PREF_FORMATTER_INDENTATION_SIZE,
				PREF_FORMATTER_INDENTATION_WRAPPED_LINE_SIZE, PREF_FORMATTER_INDENTATION_ARRAY_INIT_SIZE };
	}
	...
	protected void validateValues(Widget w) {
		...
		if (c == indentSizeTxt) {
			validateSettings(PREF_FORMATTER_INDENTATION_SIZE, Integer.valueOf(fIndentationSize).toString(),
					textFieldStr);
		} else if (c == tabSizeTxt) {
			validateSettings(PREF_FORMATTER_TAB_SIZE, Integer.valueOf(fTabSize).toString(), textFieldStr);
		} else if (c == fDefaultIndentWrapLineSizeTxt) {
			validateSettings(PREF_FORMATTER_INDENTATION_WRAPPED_LINE_SIZE,
					Integer.valueOf(fIndentationWrappedLineSize).toString(), textFieldStr);
		} else if (c == fDefaultIndentArrayInitSizeTxt) {
			validateSettings(PREF_FORMATTER_INDENTATION_ARRAY_INIT_SIZE,
					Integer.valueOf(fIndentationArrayInitSize).toString(), textFieldStr);
		}
	}
