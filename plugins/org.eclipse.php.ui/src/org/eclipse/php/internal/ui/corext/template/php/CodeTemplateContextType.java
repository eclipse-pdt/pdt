...
public class CodeTemplateContextType extends ScriptTemplateContextType {
	...
	public static final String CATCHBLOCK_CONTEXTTYPE = PHP_PREFIX + "catchblock_context"; //$NON-NLS-1$
	public static final String METHODBODY_CONTEXTTYPE = PHP_PREFIX + "methodbody_context"; //$NON-NLS-1$
	public static final String CONSTRUCTORBODY_CONTEXTTYPE = PHP_PREFIX + "constructorbody_context"; //$NON-NLS-1$
	public static final String GETTERBODY_CONTEXTTYPE = PHP_PREFIX + "getterbody_context"; //$NON-NLS-1$
	public static final String SETTERBODY_CONTEXTTYPE = PHP_PREFIX + "setterbody_context"; //$NON-NLS-1$
	public static final String NEWTYPE_CONTEXTTYPE = PHP_PREFIX + "newtype_context"; //$NON-NLS-1$
	public static final String CLASSBODY_CONTEXTTYPE = PHP_PREFIX + "classbody_context"; //$NON-NLS-1$
	public static final String INTERFACEBODY_CONTEXTTYPE = PHP_PREFIX + "interfacebody_context"; //$NON-NLS-1$
	public static final String ENUMBODY_CONTEXTTYPE = PHP_PREFIX + "enumbody_context"; //$NON-NLS-1$
	public static final String ANNOTATIONBODY_CONTEXTTYPE = PHP_PREFIX + "annotationbody_context"; //$NON-NLS-1$
	public static final String FILECOMMENT_CONTEXTTYPE = PHP_PREFIX + "filecomment_context"; //$NON-NLS-1$
	public static final String TYPECOMMENT_CONTEXTTYPE = PHP_PREFIX + "typecomment_context"; //$NON-NLS-1$
	public static final String FIELDCOMMENT_CONTEXTTYPE = PHP_PREFIX + "fieldcomment_context"; //$NON-NLS-1$
	public static final String MULTIFIELDCOMMENT_CONTEXTTYPE = PHP_PREFIX + "multifieldcomment_context"; //$NON-NLS-1$
	public static final String METHODCOMMENT_CONTEXTTYPE = PHP_PREFIX + "methodcomment_context"; //$NON-NLS-1$
	public static final String CONSTRUCTORCOMMENT_CONTEXTTYPE = PHP_PREFIX + "constructorcomment_context"; //$NON-NLS-1$
	public static final String OVERRIDECOMMENT_CONTEXTTYPE = PHP_PREFIX + "overridecomment_context"; //$NON-NLS-1$
	public static final String DELEGATECOMMENT_CONTEXTTYPE = PHP_PREFIX + "delegatecomment_context"; //$NON-NLS-1$
	public static final String GETTERCOMMENT_CONTEXTTYPE = PHP_PREFIX + "gettercomment_context"; //$NON-NLS-1$
	public static final String SETTERCOMMENT_CONTEXTTYPE = PHP_PREFIX + "settercomment_context"; //$NON-NLS-1$

	public static final String NEW_FILE_CONTEXTTYPE = PHP_PREFIX + "new_file_context"; //$NON-NLS-1$
	public static final String NEW_HTMLFILE_CONTEXTTYPE = PHP_PREFIX + "new_htmlfile_context"; //$NON-NLS-1$
	...
	public static final String NEWHTMLFILE_ID = CODETEMPLATES_PREFIX + "html.frameset"; //$NON-NLS-1$
	...
	public static final String MULTIFIELDCOMMENT_ID = CODETEMPLATES_PREFIX + "multifield" + COMMENT_SUFFIX; //$NON-NLS-1$
	...
	*//**
	 ...
	 * required.remove(type); } if (!required.isEmpty()) { String missing=
	 * BasicElementLabels.getJavaElementName((String) required.get(0)); throw
	 * newTemplateException(Messages.format(PhpTemplateMessages.
	...
	public static void registerContextTypes(ContextTypeRegistry registry) {
		...
		registry.addContextType(new CodeTemplateContextType(CodeTemplateContextType.MULTIFIELDCOMMENT_CONTEXTTYPE));
		...
		registry.addContextType(new CodeTemplateContextType(CodeTemplateContextType.NEW_FILE_CONTEXTTYPE,
