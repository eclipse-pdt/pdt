...
public class PHPValidationPreferencePage extends PropertyAndPreferencePage {
	...
	private PHPValidationOptionsConfigurationBlock fConfigurationBlock;
	...
	public void createControl(Composite parent) {
		...
		fConfigurationBlock = new PHPValidationOptionsConfigurationBlock(getNewStatusChangedListener(), getProject(),
				container);
