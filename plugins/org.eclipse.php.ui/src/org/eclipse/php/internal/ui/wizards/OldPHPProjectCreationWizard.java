...
public class OldPHPProjectCreationWizard extends DataModelWizard implements IExecutableExtension, INewWizard {
	...
	public OldPHPProjectCreationWizard(IDataModel model) {
		super(model);
		populateWizardFactoryList();
	}

	public OldPHPProjectCreationWizard() {
		super();
		populateWizardFactoryList();
	}
