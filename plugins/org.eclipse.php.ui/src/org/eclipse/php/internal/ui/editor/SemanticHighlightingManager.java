...
public class SemanticHighlightingManager implements IPropertyChangeListener {
	 ...
	 */
	public void install(PHPStructuredEditor editor, PHPStructuredTextViewer sourceViewer, ColorManager colorManager, IPreferenceStore preferenceStore) {
		fEditor= editor;
	 ...
	 */
	public void install(PHPStructuredTextViewer sourceViewer, ColorManager colorManager, IPreferenceStore preferenceStore, HighlightedRange[][] hardcodedRanges) {
