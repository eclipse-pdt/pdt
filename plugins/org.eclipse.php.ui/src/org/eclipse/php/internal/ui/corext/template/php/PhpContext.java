 ...
 */
public class PhpContext extends CompilationUnitContext {
	 ...
	 */
	public PhpContext(TemplateContextType type, IDocument document, int completionOffset, int completionLength, ICompilationUnit compilationUnit) {
	 ...
	 * @since 3.2
	 */
	public PhpContext(TemplateContextType type, IDocument document, Position completionPosition, ICompilationUnit compilationUnit) {
...
//				return resolver.createVariable();
	...
	private static void handleException(Shell shell, Exception e) {
		String title= PhpTemplateMessages.JavaContext_error_title;
		if (e instanceof CoreException)
			...
			if (message == null) {
				message= PhpTemplateMessages.JavaContext_unexpected_error_message;
			}
