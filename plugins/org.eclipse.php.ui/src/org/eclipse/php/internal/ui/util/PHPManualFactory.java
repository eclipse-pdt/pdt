...
public class PHPManualFactory {
	...
	public static PHPManual getManual() {
		String storedConfigString = PreferenceConstants.getPreferenceStore().getString(PreferenceConstants.PHP_MANUAL_SITE);
		...
		if (manual == null || !fStoredConfig.equals(storedConfigString)) {
			...
			for (int i = 0; i < descs.length; ++i) {
				// here we don't check anything except the URL since we are using a predefined sites with fixed extensions.
