...
class ActionFilterContributorsRegistry {
	...
	private ActionFilterContributorsRegistry() {
		IConfigurationElement[] elements = Platform.getExtensionRegistry().getConfigurationElementsFor(PHPUiPlugin.ID, EXTENSION_POINT);
	 ...
	 * @param id ID of the action filter contributor
	 * @return action filter contributor if it was found, otherwise <code>null</code> 
	 */
