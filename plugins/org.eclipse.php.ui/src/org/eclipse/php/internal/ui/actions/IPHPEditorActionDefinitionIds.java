...
public interface IPHPEditorActionDefinitionIds extends ITextEditorActionDefinitionIds {
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.rename.element"</code>).
	 */
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.show.outline"</code>).
	 * 
	 * @since 2.1
	 */
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.comment"</code>).
	 */
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.indent"</code>).
	 */
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.format"</code>).
	 */
	public static final String FORMAT = "org.eclipse.php.ui.edit.text.format"; //$NON-NLS-1$

	/**
	 * Action definition id of the  quick format action
	 * (value: <code>"org.eclipse.php.ui.edit.text.quick.format"</code>).
	 * @since 3.0
	 */
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.open.editor"</code>).
	 */
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.show.in.navigator.view"</code>).
	 */
	 ...
	 * (value <code>"org.eclipse.php.ui.edit.text.remove.occurrence.annotations"</code>).
	 * @since 3.0
	 */
