...
public class PhpFormatter {
	...
	/**
	 * Creates a PhpFormatter with the target line delimiter.
	 * 
	 ...
	 */
	public PhpFormatter(String lineDelimiter, int initialIndentLevel, boolean useCodeFormatter, IJavaProject project) {
