...
public class PHPEditorPreferencePage extends AbstractPreferencePage {
	...
	private void createMainComposite(Composite parent) {
		...
		useSmartHomeEndCB.setText(PHPUIMessages
				.getString("PHPEditorPreferencePage_smartCaretPositioning"));

		gd = new GridData(GridData.FILL_HORIZONTAL);
		useSmartSubWordNavigation = new Button(firstComposite, SWT.CHECK
				| SWT.LEFT);
		useSmartSubWordNavigation.setLayoutData(gd);
		useSmartSubWordNavigation.setText(PHPUIMessages
				.getString("PHPEditorPreferencePage.0")); //$NON-NLS-1$
	}
	...
	private void createHeader(Composite contents) {
		...
		String text = PHPUIMessages
				.getString("PHPEditorPreferencePage_prefEditorMessage");
		...
		link.setToolTipText(PHPUIMessages
				.getString("PHPEditorPreferencePage_prefEditorTooltip"));
