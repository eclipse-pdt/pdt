 ...
 * 
	 *
 */
public class GenerateIncludePathActionGroup extends ActionGroup /*org.eclipse.dltk.internal.ui.wizards.buildpath.newsourcepage.GenerateBuildPathActionGroup*/ {
    /**
    ...
    private static abstract class OpenPHPIncludePathWizardAction extends AbstractOpenWizardAction implements ISelectionChangedListener {    	    	    	
		/**
		 * {@inheritDoc}
		 */
    ...
    public void fillContextMenu(IMenuManager menu) {
        ...
        if (!canOperateOnSelection())
        	return;
        String menuText = PHPUIMessages.getString("IncludePathActionGroup_label");
