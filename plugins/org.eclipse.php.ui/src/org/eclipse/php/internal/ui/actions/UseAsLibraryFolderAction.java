...
import static org.eclipse.php.internal.ui.util.LibraryFolderUIHelper.useAsLibraryFolder;
 ...
 * {@link LibraryFolderUIHelper#useAsLibraryFolder(IModelElement[], IProgressMonitor)}
	...
	public void run() {
		...
		WorkspaceModifyOperation op = new WorkspaceModifyOperation() {
			...
			protected void execute(IProgressMonitor monitor)
				...
				useAsLibraryFolder(fElements, monitor);
			}
		};
