 ...
 * </dl>
 */
public class PhpContextType extends AbstractPhpContextType {
	...
	protected void initializeContext(PhpContext context) {
		if (!getId().equals(PhpContextType.ID_ALL)) { // a specific context must also allow the templates that work everywhere 
			context.addCompatibleContextType(PhpContextType.ID_ALL); 
		}
	}
