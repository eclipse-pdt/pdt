package org.eclipse.php.internal.ui.decorators;
...
public class OverrideIndicatorLabelDecorator implements ILabelDecorator,
	...
	protected int getOverrideIndicators(IMethod method) throws ModelException,
		...
		if (defining != null) {
			if (isAbstract(defining)) {
				return PHPElementImageDescriptor.IMPLEMENTS;
			} else {
				return PHPElementImageDescriptor.OVERRIDES;
			}
		}
		return 0;
	}
	...
	public void decorate(Object element, IDecoration decoration) {
		int adornmentFlags = computeAdornmentFlags(element);
		if ((adornmentFlags & PHPElementImageDescriptor.IMPLEMENTS) != 0) {

			decoration.addOverlay(PHPPluginImages.DESC_OVR_IMPLEMENTS);
		} else if ((adornmentFlags & PHPElementImageDescriptor.OVERRIDES) != 0) {

			decoration.addOverlay(PHPPluginImages.DESC_OVR_OVERRIDES);
		}
	}
