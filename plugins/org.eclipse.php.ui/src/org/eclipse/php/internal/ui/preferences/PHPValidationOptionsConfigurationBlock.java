...
public class PHPValidationOptionsConfigurationBlock extends PHPCoreOptionsConfigurationBlock {
	...
	public PHPValidationOptionsConfigurationBlock(IStatusChangeListener context, IProject project,
	...
	protected Control createContents(Composite parent) {
		...
		Composite optionsComposite = createSubsection(control, PHPUIMessages.validationPage_options_title);
	...
	private void addOptionsSection(Composite composite) {
		...
		label = PHPUIMessages.validationPage_options_bindNamespace;
		addCheckBox(composite, label, PREF_BIND_NAMESPACE, new String[] { "True", "False" }, 0); //$NON-NLS-1$ //$NON-NLS-2$

		label = PHPUIMessages.validationPage_options_bindTypeName;
