...
import org.eclipse.php.internal.ui.corext.template.php.CompilationUnitCompletion.Variable;
 ...
 * @since 3.4
 */
public abstract class AbstractPhpContextType extends CompilationUnitContextType {
	...
	protected static abstract class AbstractIterable extends TemplateVariableResolver {
		...
		abstract protected Variable[] getLocalVariables(PhpContext jc);
	...
	protected static class Array extends AbstractIterable {
		public Array() {
			super("array", PhpTemplateMessages.JavaContextType_variable_description_array);  //$NON-NLS-1$
		}
		
		protected Variable[] getLocalVariables(PhpContext jc) {
			return jc.getArrays();
		}
	}
	...
	protected static class Iterable extends AbstractIterable {
		public Iterable() {
		    super("iterable", PhpTemplateMessages.JavaContextType_variable_description_iterable);  //$NON-NLS-1$
		}
	...
	protected static class ArrayType extends AbstractIterableType {
		public ArrayType() {
			super("array_type", PhpTemplateMessages.JavaContextType_variable_description_array_type, "array");  //$NON-NLS-1$ //$NON-NLS-2$
		}
		protected Variable[] getLocalVariables(PhpContext jc) {
			return jc.getArrays();
		}
	...
	protected static class IterableType extends AbstractIterableType {
		public IterableType() {
	     	super("iterable_type", PhpTemplateMessages.JavaContextType_variable_description_iterable_type, "iterable");  //$NON-NLS-1$ //$NON-NLS-2$
		}
		protected Variable[] getLocalVariables(PhpContext jc) {
			return jc.getIterables();
		}
	...
	protected static class ArrayElement extends AbstractIterableElement {
		public ArrayElement() {
			super("array_element", PhpTemplateMessages.JavaContextType_variable_description_array_element, "array");	 //$NON-NLS-1$ //$NON-NLS-2$
		}
		protected Variable[] getLocalVariables(PhpContext jc) {
			return jc.getArrays();
		}
	...
	protected static class IterableElement extends AbstractIterableElement {
		public IterableElement() {
	     	super("iterable_element", PhpTemplateMessages.JavaContextType_variable_description_iterable_element, "iterable");	 //$NON-NLS-1$ //$NON-NLS-2$
		}
		protected Variable[] getLocalVariables(PhpContext jc) {
			return jc.getIterables();
		}
	...
	protected static class Index extends NameResolver {
	    public Index() {
	    	super("int"); //$NON-NLS-1$
	     	...
	     	setDescription(PhpTemplateMessages.JavaContextType_variable_description_index);
	    }
	}
	...
	protected static class Collection extends LocalVarResolver {
	    public Collection() {
	    	...
	    	setDescription(PhpTemplateMessages.JavaContextType_variable_description_collection);
		}
	}
	...
	protected static class Iterator extends NameResolver {
	    public Iterator() {
	    	super("java.util.Iterator"); //$NON-NLS-1$
	     	...
	     	setDescription(PhpTemplateMessages.JavaContextType_variable_description_iterator);
		}
	}
	...
	protected static class Todo extends TemplateVariableResolver {
		...
		public Todo() {
			super("todo", PhpTemplateMessages.JavaContextType_variable_description_todo);  //$NON-NLS-1$
		}
		protected String resolve(TemplateContext context) {
			PhpContext phpContext= (PhpContext) context;
			ICompilationUnit compilationUnit= phpContext.getCompilationUnit();
...
*/
	...
	public CompilationUnitContext createContext(IDocument document, int offset, int length, ICompilationUnit compilationUnit) {
		PhpContext phpContext= new PhpContext(this, document, offset, length, compilationUnit);
		initializeContext(phpContext);
		return phpContext;
	}
	...
	public CompilationUnitContext createContext(IDocument document, Position completionPosition, ICompilationUnit compilationUnit) {
		PhpContext phpContext= new PhpContext(this, document, completionPosition, compilationUnit);
		initializeContext(phpContext);
		return phpContext;
	}
