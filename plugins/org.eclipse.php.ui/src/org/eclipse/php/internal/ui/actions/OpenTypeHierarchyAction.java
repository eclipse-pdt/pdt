...
import org.eclipse.php.internal.ui.util.PHSelectionUtil;
...
public class OpenTypeHierarchyAction extends SelectionDispatchAction implements IUpdate {
	...
	private boolean isEnabled(ITextSelection selection) {
		...
		if (fEditor.getModelElement() instanceof ISourceModule) {
			...
			IModelElement element = PHSelectionUtil.getSelectionModelElement(selection.getOffset(),
	...
	public void run(ITextSelection selection) {
		...
		final IModelElement selectionModelElement = PHSelectionUtil.getSelectionModelElement(selection.getOffset(),
