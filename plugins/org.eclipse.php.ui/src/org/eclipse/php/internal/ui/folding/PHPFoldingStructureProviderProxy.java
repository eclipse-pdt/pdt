...
/**
 * A proxy IProjectionListener and IStructuredTextFoldingProvider for the PHP code folding
 * extentions.
 * This proxy checks the PHPFoldingStructureProviderRegistry for the current IProjectionListener
 * and IStructuredTextFoldingProvider and propogate the request to them.
 *
 * @author shalom
 */
