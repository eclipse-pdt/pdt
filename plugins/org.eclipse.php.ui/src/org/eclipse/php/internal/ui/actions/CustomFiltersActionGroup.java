...
import org.eclipse.php.internal.ui.filters.CustomFiltersDialog;
import org.eclipse.php.internal.ui.filters.FilterDescriptor;
import org.eclipse.php.internal.ui.filters.NamePatternFilter;
...
public class CustomFiltersActionGroup extends ActionGroup {
	 ...
	 * be called by clients outside of PDT/UI.
	 * </p>
	 * 
	...
	private void initializeWithPluginContributions() {
		...
		for (int i = 0; i < filterDescs.length; i++) {
			...
			if (fEnabledFilterIds.containsKey(id))
				PHPUiPlugin.logErrorMessage("WARNING: Duplicate id for extension-point \"org.eclipse.php.ui.phpElementFilters\""); //$NON-NLS-1$
	...
	private String[] getUserAndBuiltInPatterns() {
		...
		for (int i = 0; i < filterDescs.length; i++) {
			...
			if (isEnabled != null && isPatternFilter &&  !isCustomFilter && ((Boolean) isEnabled).booleanValue())
