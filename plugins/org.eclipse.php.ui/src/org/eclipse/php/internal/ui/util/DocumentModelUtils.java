...
public class DocumentModelUtils {
	 ...
	 * below), since we left document's PhpScriptRegions untouched.
	 * 
	 * @param document
	 * @param project
	 */
	...
	/**
	 * Reparse PhpScriptRegions of document attached to textViewer. Also do a
	 * document reconcile afterwards.
	 * 
	 * @param textViewer
	 */
	...
	/**
	 * Reparse PhpScriptRegions of document attached to textViewer, by using new
	 * project settings. Also do a document reconcile afterwards. If parameter
	...
	/**
	 * Reparse all document's PhpScriptRegions.
	 * 
	 * @param document
	 */
	...
	/**
	 * Reparse all document's PhpScriptRegions, by using new project settings.
	 * If parameter project is not null, be sure that the document really
	 ...
	 * @param project
	 *            the new projet to use (only if setNewProject is set to true)
	 * @param setNewProject
