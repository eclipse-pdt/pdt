...
public class DocumentModelUtils {
	 ...
	 * below), since we left document's PhpScriptRegions content untouched.
	 * 
	 * @param document
	 * @param project
	 */
	...
	/**
	 * Reparse all document's PhpScriptRegions content.
	 * 
	 * @param document
	 */
	...
	/**
	 * Reparse all document's PhpScriptRegions content, by using new project
