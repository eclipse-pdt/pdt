...
public class TypeWizardConstants {
	...
	public final static String CLASS_TEMPLATE_LOCATION = "resources/templates/ClassTemplate.tpl.php"; //$NON-NLS-1$
	public final static String INTERFACE_TEMPLATE_LOCATION = "resources/templates/InterfaceTemplate.tpl.php"; //$NON-NLS-1$
	public final static String CLASS_TYPE = "class"; //$NON-NLS-1$
	public final static String INTERFACE_TYPE = "interface"; //$NON-NLS-1$
	public final static String TRAIT_TYPE = "trait"; //$NON-NLS-1$
	public final static String PHP5_CONSTRUCTOR_TEMPLATE = "__construct"; //$NON-NLS-1$
	public final static String PHP5_DESTRUCTOR_TEMPLATE = "__destruct"; //$NON-NLS-1$
	public final static String PRIVATE_MODIFIER = "private"; //$NON-NLS-1$
