 ...
 */
public class PhpDocContext extends CompilationUnitContext {
	 ...
	 */
	public PhpDocContext(TemplateContextType type, IDocument document, int completionOffset, int completionLength, ICompilationUnit compilationUnit) {
	 ...
	 * @since 3.2
	 */
	public PhpDocContext(TemplateContextType type, IDocument document, Position completionPosition, ICompilationUnit compilationUnit) {
