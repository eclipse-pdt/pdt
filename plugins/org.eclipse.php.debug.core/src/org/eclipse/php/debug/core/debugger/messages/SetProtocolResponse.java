...
import org.eclipse.php.debug.core.debugger.messages.DebugMessageResponseImpl;
...
public class SetProtocolResponse extends DebugMessageResponseImpl implements IDebugResponseMessage {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.php.debug.core.debugger.messages.IDebugMessage#deserialize(java.io.DataInputStream)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.php.debug.core.debugger.messages.IDebugMessage#serialize(java.io.DataOutputStream)
	 */
