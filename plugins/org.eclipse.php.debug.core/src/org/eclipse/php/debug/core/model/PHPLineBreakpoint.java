...
public class PHPLineBreakpoint extends LineBreakpoint {
    ...
    protected org.eclipse.php.debug.core.debugger.Breakpoint fBreakpoint;
    ...
    protected void createRuntimeBreakpoint(IMarker marker) throws CoreException {       
        ...
        fBreakpoint = new org.eclipse.php.debug.core.debugger.Breakpoint(fileName, (lineNumber.intValue()));
        fBreakpoint.setEnable(true);
    }

    public org.eclipse.php.debug.core.debugger.Breakpoint getRuntimeBreakpoint() {
        return fBreakpoint;
    }
