...
import org.eclipse.php.debug.core.*;
...
public class PHPDebugTarget extends PHPDebugElement implements IDebugTarget, IBreakpointManagerListener {
    ...
    private String fPHPExe;
    private IFile fFileToDebug;
    private boolean fIsStopAtFirstLine;
    private DebugOutput fOutput = new DebugOutput(); 
    private static Hashtable fUsedPorts = new Hashtable();
    ...
    private org.eclipse.php.debug.core.debugger.Debugger.StartResponseHandler fStartResponseHandler;
    private org.eclipse.php.debug.core.debugger.Debugger.BreakpointAddedResponseHandler fBreakpointAddedResponseHandler;
    private org.eclipse.php.debug.core.debugger.Debugger.BreakpointRemovedResponseHandler fBreakpointRemovedResponseHandler;
    private org.eclipse.php.debug.core.debugger.Debugger.StepIntoResponseHandler fStepIntoResponseHandler;
    private org.eclipse.php.debug.core.debugger.Debugger.StepOverResponseHandler fStepOverResponseHandler;
    private org.eclipse.php.debug.core.debugger.Debugger.StepOutResponseHandler fStepOutResponseHandler;
    private org.eclipse.php.debug.core.debugger.Debugger.GoResponseHandler fGoResponseHandler;
    private org.eclipse.php.debug.core.debugger.Debugger.PauseResponseHandler fPauseResponseHandler;
    ...
    class RunDispatchJobWebServer extends Job {
        ...
        public RunDispatchJobWebServer() {
        ...
        protected IStatus run(IProgressMonitor monitor) {
            ...
            Logger.debugMSG("PHPDebugTarget: Calling Terminated()");
            terminated();
     ...
     */
    public PHPDebugTarget(ILaunch launch, String URL, int requestPort, IProcess process, String contextRoot, boolean runAsDebug, boolean stopAtFirstLine, IProject project) throws CoreException {
        super(null);
        ...
        fRunDispatch = new RunDispatchJobWebServer();
    ...
    private void initDebugTarget(ILaunch launch, int requestPort, IProcess process, boolean runAsDebug, boolean stopAtFirstLine, IProject project) throws CoreException {
        ...
        fIsStopAtFirstLine = stopAtFirstLine;
        fProject = project;
        if (project != null)fProjectName = project.getName();
    ...
    public void debugPHPExecutable(String phpExe, String fileToDebug, int port, boolean stopAtFirstLine) throws DebugException{
        try {
            if (!debugger.isActive()) {
                debugger.openConnection(port);
            }
            PHPExecutableDebuggerInitializer debuggerInitializer = new PHPExecutableDebuggerInitializer(fLaunch);
            debuggerInitializer.initializeDebug(new File(phpExe).getAbsolutePath(), new File(fileToDebug).getAbsolutePath(), port, stopAtFirstLine);
    ...
    public void terminated() {
        ...
        if (!fTermainateCalled) debugger.closeConnection();
        Logger.debugMSG("PHPDebugTarget: releasing port " + fRequestPort);
        synchronized (fUsedPorts){ 
            fUsedPorts.remove(String.valueOf(fRequestPort));
        } 
        completeTerminated();
    }
    ...
    public void breakpointChanged(IBreakpoint breakpoint, IMarkerDelta delta) {
        if (!fBreakpointManager.isEnabled())return;
    ...
    public void started() {
        fSuspended = false;
        if (!fIsRunAsDebug)installDeferredBreakpoints();
        fireCreationEvent();
    }
