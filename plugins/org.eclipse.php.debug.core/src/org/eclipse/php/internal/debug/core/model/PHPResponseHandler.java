...
public class PHPResponseHandler {
    ...
    public class StartResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.StartResponseHandler {
    ...
    public class BreakpointAddedResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.BreakpointAddedResponseHandler {
    ...
    public class BreakpointRemovedResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.BreakpointRemovedResponseHandler {
...
//                Logger.log(Logger.ERROR, "PHPResponseHandler: BreakpointRemovedResponseHandler failed " + id);
    ...
    public class StepIntoResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.StepIntoResponseHandler {
    ...
    public class StepOverResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.StepOverResponseHandler {
    ...
    public class StepOutResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.StepOutResponseHandler {
    ...
    public class GoResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.GoResponseHandler {
    ...
    public class PauseResponseHandler implements org.eclipse.php.internal.debug.core.debugger.Debugger.PauseResponseHandler {
