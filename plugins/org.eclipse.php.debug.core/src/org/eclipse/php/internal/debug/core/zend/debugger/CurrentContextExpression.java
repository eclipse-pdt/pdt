...
public class CurrentContextExpression extends DefaultExpression {
	...
	private final static String GET_EXTENDED_CONTEXT = "eval('" //$NON-NLS-1$
			...
			+ "else if (isset($this))" //$NON-NLS-1$
			+ "{ return array_merge(array(\\'this\\' => $this), get_defined_vars(), array(false)); }" //$NON-NLS-1$
			+ "else" //$NON-NLS-1$
