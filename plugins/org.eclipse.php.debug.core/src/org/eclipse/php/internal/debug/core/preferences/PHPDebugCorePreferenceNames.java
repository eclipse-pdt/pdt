...
public class PHPDebugCorePreferenceNames {
	...
	public static final String ZEND_DEBUG_BROADCAST_PORT = Debug_ID + "zend_debug_broadcast_port"; //$NON-NLS-1$
	public static final String ZEND_DEBUG_DUMMY_FILE = Debug_ID + "zend_debug_dummy_file"; //$NON-NLS-1$
	...
	public static final String INSTALLED_PHP_UNIQUE_IDS = Debug_ID + "installedPHPUniqueIds"; //$NON-NLS-1$
	...
	public static final String INSTALLED_PHP_LOAD_DEFAULT_INIS = Debug_ID + "installedPHPLoadIniDefaults"; //$NON-NLS-1$
	...
	public static final String INSTALLED_PHP_DEFAULT_FOR_VERSIONS = Debug_ID + "php_versions"; //$NON-NLS-1$
