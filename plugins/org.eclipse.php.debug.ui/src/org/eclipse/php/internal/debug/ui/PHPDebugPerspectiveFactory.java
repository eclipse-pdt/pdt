...
public class PHPDebugPerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		IFolderLayout outlineFolder = layout.createFolder(ID_Debug_INFO_FOLDER,
		...
		IFolderLayout navFolder = layout.createFolder(ID_NAVIGATOR_FOLDER_VIEW,
				IPageLayout.TOP, (float) 0.45, layout.getEditorArea());
		navFolder.addView(IDebugUIConstants.ID_DEBUG_VIEW);
		navFolder.addPlaceholder(IPageLayout.ID_RES_NAV);

		IFolderLayout toolsFolder = layout.createFolder(ID_TOOLS_FOLDER_VIEW,
				IPageLayout.RIGHT, (float) 0.50, ID_NAVIGATOR_FOLDER_VIEW);
		...
		// layout.createFolder(ID_OUTLINE_FOLDER_VIEW, IPageLayout.RIGHT,
