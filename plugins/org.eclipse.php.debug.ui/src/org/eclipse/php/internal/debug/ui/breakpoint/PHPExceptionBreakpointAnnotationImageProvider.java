...
import org.eclipse.php.internal.debug.ui.presentation.PHPModelPresentation.ExceptionAnnotation;
...
public class PHPExceptionBreakpointAnnotationImageProvider implements IAnnotationImageProvider {
	...
	public String getImageDescriptorId(Annotation annotation) {
		switch (((ExceptionAnnotation) annotation).getBreakpoint().getType()) {
		case ERROR:
