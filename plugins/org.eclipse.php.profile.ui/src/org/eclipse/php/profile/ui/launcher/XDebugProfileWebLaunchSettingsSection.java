...
public class XDebugProfileWebLaunchSettingsSection extends AbstractProfileWebLaunchSettingsSection {
	...
	protected void buildSection(Composite parent) {
		...
		useTrigger.setText(
				"Append XDebug trigger GET parameter to URL. Disable if you set 'xdebug.profiler_enable_trigger' as 0");
		...
		new Label(sub, SWT.NONE).setText("xdebug.profiler_enable_trigger_value (xdebug >= 2.3)");
