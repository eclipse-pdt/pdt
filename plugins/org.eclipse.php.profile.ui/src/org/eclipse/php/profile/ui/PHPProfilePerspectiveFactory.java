...
public class PHPProfilePerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		IFolderLayout executionFolder = layout.createFolder(ID_EXECUTION_VIEW,
		...
		executionFolder.addPlaceholder(
				ProfilerUIConstants.FUNCTION_INVOCATION_STATISTICS_VIEW + ":*"); //$NON-NLS-1$
		// executionFolder.addPlaceholder(ProfilerUIConstants.CODE_COVERAGE_VIEW
		// + ":*"); //$NON-NLS-1$

		IFolderLayout outlineFolder = layout.createFolder(ID_DEBUGGING_VIEW,
		...
		IFolderLayout navFolder = layout.createFolder(ID_PROFILE_MONITOR_VIEW,
				IPageLayout.LEFT, 0.25f, ID_EXECUTION_VIEW);
