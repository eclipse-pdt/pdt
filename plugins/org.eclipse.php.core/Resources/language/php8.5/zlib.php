...
/**
 * zlib library version is incompatible with the version assumed by the caller.
 * @link http://www.php.net/manual/en/zlib.constants.php
 * @var int
 */
define ('ZLIB_VERSION_ERROR', -6);

// End of zlib v.8.5.0-dev
