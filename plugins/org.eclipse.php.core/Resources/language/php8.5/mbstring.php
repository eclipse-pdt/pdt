 ...
 * @link http://www.php.net/manual/en/function.mb-ucfirst.php
 * @param string $string The input string.
 * @param string|null $encoding [optional] The string encoding.
 ...
 * @link http://www.php.net/manual/en/function.mb-lcfirst.php
 * @param string $string The input string.
 ...
 * @link http://www.php.net/manual/en/function.mb-trim.php
 ...
 * @link http://www.php.net/manual/en/function.mb-ltrim.php
 * @param string $string The input string.
 * @param string|null $characters [optional] >
 * Optionally, the stripped characters can also be specified using
 * the characters parameter.
 ...
 * @link http://www.php.net/manual/en/function.mb-rtrim.php
 * @param string $string The input string.
 * @param string|null $characters [optional] >
 * Optionally, the stripped characters can also be specified using
 * the characters parameter.
 ...
 * @param string $string The input string.
 * @param string|null $encoding [optional] The encoding used to interpret string.
 * If it is omitted or null, the
 * mbstring.internal_encoding setting
 * will be used if set, otherwise the default_charset setting
 * will be used.
 * @return string The string result with invalid byte sequences replaced.
 */
 ...
 * @link http://www.php.net/manual/en/function.mb-str-pad.php
 * @param string $string 
 * @param int $length 
 ...
 * @var string
 */
define ('MB_ONIGURUMA_VERSION', "6.9.10");
