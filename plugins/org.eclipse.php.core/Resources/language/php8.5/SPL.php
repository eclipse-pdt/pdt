...
class SplFileObject extends SplFileInfo implements Stringable, RecursiveIterator, Traversable, Iterator, SeekableIterator {
	 ...
	 * By default " or the value set by a prior call to
	 * SplFileObject::setCsvControl.
	 * @param string $escape [optional] The escape character (at most one single-byte character).
	 * By default \ or the value set by a prior call to
	 * SplFileObject::setCsvControl.
	 ...
	 * @param string $separator [optional] The separator parameter sets the field separator.
	 * It must be a single byte character.
	 * @param string $enclosure [optional] The enclosure parameter sets the field enclosure character.
	 * It must be a single byte character.
	 * @param string $escape [optional] The escape parameter sets the escape character.
	 ...
	 * @return string Returns the current line as a string.
	 */
	public function __toString (): string {}
...
class SplFixedArray implements IteratorAggregate, Traversable, ArrayAccess, Countable, JsonSerializable {
	 ...
	 * @link http://www.php.net/manual/en/splfixedarray.serialize.php
	 ...
	 * @link http://www.php.net/manual/en/splfixedarray.unserialize.php
	 ...
	 * @link http://www.php.net/manual/en/splfixedarray.getiterator.php
	 * @return Iterator An instance of an object implementing Iterator to go
	 * through the array.
	 */
	public function getIterator (): Iterator {}
	 ...
	 * @link http://www.php.net/manual/en/splfixedarray.jsonserialize.php
	 * @return array Returns array data which can be serialized by json_encode,
...
class SplObjectStorage implements Countable, SeekableIterator, Traversable, Iterator, Serializable, ArrayAccess {
	 ...
	 * @link http://www.php.net/manual/en/splobjectstorage.seek.php
