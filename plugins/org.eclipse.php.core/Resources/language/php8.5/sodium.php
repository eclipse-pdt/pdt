 ...
 * @param string $nonce A number that must be only used once, per message. 12 bytes long.
 * @param string $key Encryption key (256-bit).
 * @return string Returns the ciphertext and authentication tag as a string of raw binary bytes. (Format: ciphertext, then tag.)
 */
 ...
 * @link http://www.php.net/manual/en/function.sodium-crypto-aead-aegis128l-decrypt.php
 ...
 * @return string|false Returns the plaintext on success, or false on failure.
 */
function sodium_crypto_aead_aegis128l_decrypt (string $ciphertext, string $additional_data, string $nonce, string $key): string|false {}

/**
 * Encrypt then authenticate a message with AEGIS-128L
 * @link http://www.php.net/manual/en/function.sodium-crypto-aead-aegis128l-encrypt.php
 * @param string $message The plaintext message to encrypt.
 * @param string $additional_data Additional, authenticated data. This is used in the verification of the authentication tag
 * appended to the ciphertext, but it is not encrypted or stored in the ciphertext.
 * @param string $nonce A number that must be only used once, per message.
 ...
 * @link http://www.php.net/manual/en/function.sodium-crypto-aead-aegis128l-keygen.php
 * @return string Returns a 128-bit random key.
 */
function sodium_crypto_aead_aegis128l_keygen (): string {}

/**
 * Verify then decrypt a message with AEGIS-256
 * @link http://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-decrypt.php
 ...
 * @link http://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-encrypt.php
 * @param string $message The plaintext message to encrypt.
 * @param string $additional_data Additional, authenticated data. This is used in the verification of the authentication tag
 * appended to the ciphertext, but it is not encrypted or stored in the ciphertext.
 * @param string $nonce A number that must be only used once, per message.
 ...
 * @link http://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-keygen.php
 * @return string Returns a 256-bit random key.
 */
 ...
 * @param string $salt A salt to add to the password before hashing. The salt should be unpredictable, ideally generated from a good random number source such as random_bytes, and have a length of exactly SODIUM_CRYPTO_PWHASH_SALTBYTES bytes.
 ...
 * @var string
 */
define ('SODIUM_LIBRARY_VERSION', "1.0.20");
