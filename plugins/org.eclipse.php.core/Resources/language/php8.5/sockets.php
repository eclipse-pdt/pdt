 ...
 * @link http://www.php.net/manual/en/function.socket-atmark.php
 * @param Socket $socket 
 * @return bool Returns true on success or false on failure.
 */
 ...
 * @return array|false Returns an array of AddressInfo instances that can be used with
...
/**
 * Similar to SO_LINGER but lingering is in seconds
