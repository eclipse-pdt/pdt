...
class mysqli  {
	 ...
	 * @return bool mysqli::__construct always returns an object
	 ...
	 * <p>mysqli::connect returns true on success or false on failure.
	 * Prior to PHP 8.1.0, returns null on success.</p>
	 */
	 ...
	 * @return mysqli_warning|false Returns a singly linked list comprised of
	 * mysqli_warning or false if there are no warnings.
	 */
 ...
 * @param int|null $port [optional] 
 * @param string|null $socket [optional] 
 * @return mysqli|false mysqli::__construct always returns an object
 * which represents the connection to a MySQL Server,
 * regardless of it being successful or not.
 * <p>mysqli_connect returns an object which represents the connection to a MySQL Server,
 * or false on failure.</p>
 ...
 * <p>Returns the last connection error code regardless of the instance on which it
 * is called.</p>
 */
 ...
 * <p>Returns the last connection error regardless of the instance on which it is
 * called.</p>
 */
 ...
 * from which client-side LOCAL data loading is permitted
 * in LOAD DATA LOCAL statements.
 * @link http://www.php.net/manual/en/mysqli.constants.php
 * @var int
 */
...
/**
 * A column has no DEFAULT clause in its definition.
 * This does not apply to NULL
 * or to AUTO_INCREMENT columns
