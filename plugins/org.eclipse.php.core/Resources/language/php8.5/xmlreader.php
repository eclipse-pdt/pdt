...
// Start of xmlreader v.8.5.0-dev
...
class XMLReader  {
	 ...
	 * @return bool Returns true when the document is valid or false otherwise.
	 */
	 ...
	 * @return XMLReader Returns true on success or false on failure. If called statically, returns an
	 * XMLReader or false on failure.
	 */
	public static function open (string $uri, ?string $encoding = null, int $flags = null): XMLReader {}

	/**
	 * Creates an XMLReader from a URI to read from
	 * @link http://www.php.net/manual/en/xmlreader.fromuri.php
	 * @param string $uri 
	 * @param string|null $encoding [optional] 
	 * @param int $flags [optional] 
	 * @return static Returns an XMLReader.
	 */
	public static function fromUri (string $uri, ?string $encoding = null, int $flags = null): static {}

	/**
	 * Creates an XMLReader from a stream to read from
	 * @link http://www.php.net/manual/en/xmlreader.fromstream.php
	 * @param resource $stream The stream to read the XML from.
	 * @param string|null $encoding [optional] The document encoding or null.
	 * @param int $flags [optional] A bitmask of the LIBXML_&#42;
	 * constants.
	 * @param string|null $documentUri [optional] Optional document base URI.
	 * @return static Returns an XMLReader.
	 */
	public static function fromStream ($stream, ?string $encoding = null, int $flags = null, ?string $documentUri = null): static {}
	 ...
	 * XMLReader or false on failure.
	 */
	public static function XML (string $source, ?string $encoding = null, int $flags = null): XMLReader {}

	/**
	 * Creates an XMLReader from an XML string
	 * @link http://www.php.net/manual/en/xmlreader.fromstring.php
	 * @param string $source 
	 * @param string|null $encoding [optional] 
	 * @param int $flags [optional] 
	 * @return static Returns an XMLReader.
	 */
	public static function fromString (string $source, ?string $encoding = null, int $flags = null): static {}
