...
// Start of xmlwriter v.8.5.0-dev
...
class XMLWriter  {
	 ...
	 * @link http://www.php.net/manual/en/xmlwriter.touri.php
	 * @param string $uri 
	 * @return static Returns an XMLWriter.
	 */
	...
	/**
	 * Create new XMLWriter using memory for string output
	 * @link http://www.php.net/manual/en/xmlwriter.tomemory.php
	 * @return static Returns an XMLWriter.
	 */
	 ...
	 * @link http://www.php.net/manual/en/xmlwriter.tostream.php
	 * @param resource $stream The stream to use for output.
	 * @return static Returns an XMLWriter.
	 */
