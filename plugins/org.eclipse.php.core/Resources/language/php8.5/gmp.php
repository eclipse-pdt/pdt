...
// Start of gmp v.8.5.0-dev

final class GMP  {

	/**
	 * Create GMP number
	 * @link http://www.php.net/manual/en/gmp.construct.php
	 * @param int|string $num [optional] An integer or a string. The string representation can be decimal,
	 * hexadecimal, octal, or binary.
	 * @param int $base [optional] The base to use for converting a string representation.
	 ...
	 * @return int|string 
	 */
	public function __construct (int|string $num = null, int $base = null): int|string {}
 ...
 * @param int|string $num An integer or a string. The string representation can be decimal,
 * hexadecimal, octal, or binary.
 * @param int $base [optional] The base to use for converting a string representation.
 * An explicit base can be between 2 and 62.
 * For bases up to 36, case is ignored;
 ...
 * @return GMP Returns a GMP object which contains
