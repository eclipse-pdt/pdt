...
interface DateTimeInterface  {
	 ...
	 * <p>The absolute parameter only affects the
	 * invert property of a
	 * DateInterval object.</p>
	 ...
	 * @link http://www.php.net/manual/en/datetime.serialize.php
	 * @return array The serialized representation of the
	 * DateTime object.
	 */
	 ...
	 * @link http://www.php.net/manual/en/datetime.unserialize.php
	 * @param array $data The serialized DateTime.
	 * @return void The DateTime object.
	 */
...
class DateTime implements DateTimeInterface {
	 ...
	 * @return DateTime Returns DateTime on success.
...
class DateTimeImmutable implements DateTimeInterface {
	 ...
	 * @param string $modifier A date/time string. Valid formats are explained in Date and Time Formats.
	 * @return DateTimeImmutable Returns DateTimeImmutable on success.
	 * Procedural style returns false on failure.
	 */
...
class DateInterval  {
	 ...
	 * @param string $datetime 
	 * @return DateInterval Returns DateInterval on success.
	 * Procedural style returns false on failure.
	 */
...
class DatePeriod implements IteratorAggregate, Traversable {
	 ...
	 * @link http://www.php.net/manual/en/dateperiod.createfromiso8601string.php
	 * @param string $specification A subset of the ISO 8601 repeating
	 * interval specification.
	 * <p>An example of an accepted ISO 8601 interval specifications is
	 * R5/2008-03-01T13:00:00Z/P1Y2M10DT2H30M, which
	 * specifies:</p>
	 * <p>Examples of some ISO 8601 interval specification features that PHP does
	 * not support are:</p>
	 * @param int $options [optional] A bit field which can be used to control certain behaviour with start-
	 * and end- dates.
	 * <p>With DatePeriod::EXCLUDE_START_DATE you
	 * exclude the start date from the set of recurring dates within the
	 * period.</p>
	 * <p>With DatePeriod::INCLUDE_END_DATE you
	 * include the end date in the set of recurring dates within the
	 * period.</p>
	 * @return static Creates a new DatePeriod object.
	 * <p>DatePeriod objects created with this method can be
	 * used as an iterator to generate a number of
	 * DateTimeImmutable objects.</p>
	 */
	public static function createFromISO8601String (string $specification, int $options = null): static {}
 ...
 * @param int|null $day [optional] 
 * @param int|null $year [optional] 
 * @return int|false Returns a int Unix timestamp on success, or false if the
 ...
 * @param string $modifier A date/time string. Valid formats are explained in Date and Time Formats.
 * @return DateTime|false Returns DateTime on success.
 * Procedural style returns false on failure.
 */
 ...
 * @return array Returns an array whose structure is detailed in the following list:
 * <p>sunrise
 * <br>
