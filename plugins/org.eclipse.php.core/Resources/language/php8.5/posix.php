 ...
 * @link http://www.php.net/manual/en/function.posix-sysconf.php
 * @param int $conf_id 
 * @return int Returns the numeric value related to conf_id
 */
function posix_sysconf (int $conf_id): int {}

/**
 * Returns the value of a configurable limit
 * @link http://www.php.net/manual/en/function.posix-pathconf.php
 * @param string $path 
 * @param int $name 
 * @return int|false Returns the configurable limit or false.
 */
function posix_pathconf (string $path, int $name): int|false {}

/**
 * Returns the value of a configurable limit
 * @link http://www.php.net/manual/en/function.posix-fpathconf.php
 * @param resource|int $file_descriptor 
 * @param int $name 
 * @return int|false Returns the configurable limit or false.
 */
 ...
 * @link http://www.php.net/manual/en/posix.constants.sysconf.php
 * @var int
 */
 ...
 * Available as of PHP 8.3.0.
 * @link http://www.php.net/manual/en/posix.constants.pathconf.php
 * @var int
 */
...
define ('POSIX_SC_OPEN_MAX', 5);

// End of posix v.8.5.0-dev
