...
class NumberFormatter  {
	 ...
	 * @var int
	const DECIMAL = 1;
	const DECIMAL_COMPACT_SHORT = 14;
	const DECIMAL_COMPACT_LONG = 15;
	/**
	 * Currency format
	 * @var int
	const CURRENCY = 2;
	 ...
	 * @var int
	const IGNORE = 0;
	const CURRENCY_ISO = 10;
	const CURRENCY_PLURAL = 11;
	/**
	...
	const CASH_CURRENCY = 13;
	const CURRENCY_STANDARD = 16;
	/**
	...
	const ROUND_UP = 3;
	/**
	 * Alias of NumberFormatter::ROUND_DOWN.
	const ROUND_TOWARD_ZERO = 2;
	/**
	 * Alias of NumberFormatter::ROUND_UP.
	const ROUND_AWAY_FROM_ZERO = 3;
	/**
...
final class IntlListFormatter  {
	 ...
	 */
	public function __construct (string $locale, int $type = 0, int $width = 0) {}
...
class IntlCalendar  {
	...
	/**
	 * Set a date fields
	 * @link http://www.php.net/manual/en/intlcalendar.setdate.php
	 * @param int $year The new value for IntlCalendar::FIELD_YEAR.
	 ...
	 * it) is 12.
	 * @param int $dayOfMonth The new value for IntlCalendar::FIELD_DAY_OF_MONTH.
	 ...
	 * @link http://www.php.net/manual/en/intlcalendar.setdatetime.php
	 * @param int $year The new value for IntlCalendar::FIELD_YEAR.
	 * @param int $month The new value for IntlCalendar::FIELD_MONTH.
	 * The month sequence is zero-based, i.e., January is represented by 0,
	 * February by 1, …, December is 11 and Undecember (if the calendar has
	 * it) is 12.
	 * @param int $dayOfMonth The new value for IntlCalendar::FIELD_DAY_OF_MONTH.
	 * @param int $hour The new value for IntlCalendar::FIELD_HOUR_OF_DAY.
	 * @param int $minute The new value for IntlCalendar::FIELD_MINUTE.
	 * @param int|null $second [optional] The new value for IntlCalendar::FIELD_SECOND.
	 * @return void No value is returned.
	 */
...
class IntlGregorianCalendar extends IntlCalendar  {
	 ...
	 * @link http://www.php.net/manual/en/intlgregoriancalendar.createfromdate.php
	 * @param int $year The new value for IntlGregorianCalendar::FIELD_YEAR.
	 * @param int $month The new value for IntlGregorianCalendar::FIELD_MONTH.
	 * The month sequence is zero-based, i.e., January is represented by 0,
	 * February by 1, …, December is 11 and Undecember (if the calendar has
	 * it) is 12.
	 * @param int $dayOfMonth The new value for IntlGregorianCalendar::FIELD_DAY_OF_MONTH.
	 * @return static Returns a new IntlGregorianCalendar instance.
	 */
	 ...
	 * @link http://www.php.net/manual/en/intlgregoriancalendar.createfromdatetime.php
	 * @param int $year The new value for IntlGregorianCalendar::FIELD_YEAR.
	 * @param int $month The new value for IntlGregorianCalendar::FIELD_MONTH.
	 * The month sequence is zero-based, i.e., January is represented by 0,
	 * February by 1, …, December is 11 and Undecember (if the calendar has
	 * it) is 12.
	 * @param int $dayOfMonth The new value for IntlGregorianCalendar::FIELD_DAY_OF_MONTH.
	 * @param int $hour The new value for IntlGregorianCalendar::FIELD_HOUR_OF_DAY.
	 * @param int $minute The new value for IntlGregorianCalendar::FIELD_MINUTE.
	 * @param int|null $second [optional] The new value for IntlGregorianCalendar::FIELD_SECOND.
	 * @return static Returns a new IntlGregorianCalendar instance.
	 */
...
class Spoofchecker  {
	...
	const IGNORE_SPACE = 1;
	const CASE_INSENSITIVE = 2;
	const ADD_CASE_MAPPINGS = 4;
	const SIMPLE_CASE_INSENSITIVE = 6;
	 ...
	 * @link http://www.php.net/manual/en/spoofchecker.setrestrictionlevel.php
	 * @param int $level The restriction level of SpoofChecker::isSuspicious.
	 * One of
	 * Spoofchecker::ASCII,
	 * Spoofchecker::SINGLE_SCRIPT_RESTRICTIVE,
	 * Spoofchecker::HIGHLY_RESTRICTIVE,
	 * Spoofchecker::MODERATELY_RESTRICTIVE,
	 * Spoofchecker::MINIMALLY_RESTRICTIVE, or
	 ...
	 * {@inheritdoc}
	 * @param string $pattern
	 * @param int $patternOptions [optional]
	 */
...
class IntlChar  {
	...
	const PROPERTY_IDS_UNARY_OPERATOR = 72;
	const PROPERTY_ID_COMPAT_MATH_START = 73;
	const PROPERTY_ID_COMPAT_MATH_CONTINUE = 74;
	/**
	 * @var int
	...
	/**
	 * @var int
	const PROPERTY_BINARY_LIMIT = 76;
	/**
	 * @var int
	...
	/**
	 * @var int
	const PROPERTY_OTHER_PROPERTY_LIMIT = 28674;
	/**
	 * @var int
	 ...
	 * @param int $base [optional] The radix (defaults to 10).
	 * @return int The character representation (as a int) of the specified digit in the specified radix.
	 */
 ...
 */
function intlcal_set_time_zone (IntlCalendar $calendar, IntlTimeZone|DateTimeZone|string|null $timezone = null): bool {}
 ...
 * @link http://www.php.net/manual/en/function.grapheme-str-split.php
 * @param string $string The string to split into grapheme clusters or chunks.
 * string must be valid UTF-8.
 * @param int $length [optional] Each element of the returned array will be composed of length grapheme clusters.
 * @return array|false grapheme_str_split returns an array of strings, or false on failure.
 */
 ...
 * @var string
 */
define ('INTL_ICU_DATA_VERSION', 77.1);
...
/**
 * Alias of U_MULTIPLE_DECIMAL_SEPARATORS.
 * @link http://www.php.net/manual/en/intl.constants.php
 * @var int
 */
 ...
 * @var int
 */
define ('U_FMT_PARSE_ERROR_LIMIT', 65825);
