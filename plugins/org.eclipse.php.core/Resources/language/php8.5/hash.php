 ...
 */
function hash_pbkdf2 (string $algo, string $password, string $salt, int $iterations, int $length = null, bool $binary = false, array $options = '[]'): string {}

/**
 * Timing attack safe string comparison
 * @link http://www.php.net/manual/en/function.hash-equals.php
 * @param string $known_string The known string that must be kept secret.
 * @param string $user_string The user-supplied string to compare against.
