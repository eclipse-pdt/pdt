...
final class FFI  {
	 ...
	 * definitions.
	 * <p>If lib is omitted or null, platforms supporting RTLD_DEFAULT
	 ...
	 * @param string $type A valid C declaration as string.
	 ...
	 * @return int Returns a value less than 0 if the contents of the memory area starting at ptr1
	 * are considered less than the contents of the memory area starting at ptr2,
	 * a value greater than 0 if the contents of the first memory area are considered greater than the second,
...
final class CType  {
	 ...
	 * @return int Returns the number of parameters for the underlying function type.
	 * If the underlying type is not a function, an
	 * FFI\Exception is thrown.
	 */
	 ...
	 * @param int $index Index of the function parameter, zero-based.
	 * @return \FFI\CType Returns the type of a parameter for the underlying function type.
