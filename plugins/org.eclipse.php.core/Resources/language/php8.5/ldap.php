...
/**
 * Performs an extended operation
 * @link http://www.php.net/manual/en/function.ldap-exop-sync.php
 * @param LDAP\Connection $ldap 
 * @param string $request_oid 
 * @param string|null $request_data [optional] 
 * @param array|null $controls [optional] 
 * @param string $response_data [optional] 
 * @param string $response_oid [optional] 
 * @return LDAP\Result|bool 
 */
function ldap_exop_sync (LDAP\Connection $ldap, string $request_oid, ?string $request_data = null, ?array $controls = null, string &$response_data = null, string &$response_oid = null): LDAP\Result|bool {}
...
/**
 * Alias of LDAP_OPT_X_TLS_DEMAND.
 * @link http://www.php.net/manual/en/ldap.constants.php
 * @var int
 */
