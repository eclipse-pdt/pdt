 ...
 * @return int|false xml_parse_into_struct returns 0 for failure and 1 for
 * success. This is not the same as false and true, be careful with
 * operators such as ===.
 */
function xml_parse_into_struct (XMLParser $parser, string $data, array &$values, array &$index = null): int|false {}
 ...
 * error_code, or null or "Unknown" if no description was found.
 */
 ...
 * @param XMLParser $parser 
 * @param int $option 
 * @return string|int|bool Returns the option's value.
 */
