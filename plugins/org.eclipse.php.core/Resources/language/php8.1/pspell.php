 ...
 */
function pspell_new (string $language, string $spelling = null, string $jargon = null, string $encoding = null, int $mode = null): PSpell\Dictionary|false {}
 ...
 * @return mixed an PSpell\Dictionary instance on success, or false on failure.
 */
function pspell_new_personal (string $filename, string $language, string $spelling = null, string $jargon = null, string $encoding = null, int $mode = null): PSpell\Dictionary|false {}
 ...
 */
function pspell_config_create (string $language, string $spelling = null, string $jargon = null, string $encoding = null): PSpell\Config {}
