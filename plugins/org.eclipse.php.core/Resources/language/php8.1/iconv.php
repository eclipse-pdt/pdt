 ...
 * @return int|bool Returns the character count of string, as an integer,
 * or false if an error occurs during the encoding.
 */
function iconv_strlen (string $string, ?string $encoding = null): int|bool {}
 ...
 * @param string|null $encoding [optional] 
 * @return string|bool Returns the portion of string specified by the
 ...
 */
function iconv_substr (string $string, int $offset, ?int $length = null, ?string $encoding = null): string|bool {}
 ...
 * @param string|null $encoding [optional] 
 * @return int|bool Returns the numeric position of the first occurrence of
 * needle in haystack.
 * <p>If needle is not found,
 * iconv_strpos will return false.</p>
 */
function iconv_strpos (string $haystack, string $needle, int $offset = null, ?string $encoding = null): int|bool {}
 ...
 * @param string $needle 
 * @param string|null $encoding [optional] 
 * @return int|bool Returns the numeric position of the last occurrence of
 * needle in haystack.
 * <p>If needle is not found,
 * iconv_strrpos will return false.</p>
 */
function iconv_strrpos (string $haystack, string $needle, ?string $encoding = null): int|bool {}
 ...
 * @return string|bool Returns an encoded MIME field on success,
 * or false if an error occurs during the encoding.
 */
function iconv_mime_encode (string $field_name, string $field_value, array $options = []): string|bool {}
 ...
 * @param string|null $encoding [optional] 
 * @return string|bool Returns a decoded MIME field on success,
 * or false if an error occurs during the decoding.
 */
function iconv_mime_decode (string $string, int $mode = null, ?string $encoding = null): string|bool {}
 ...
 * @param int $mode [optional] 
 * @param string|null $encoding [optional] 
 * @return array|bool Returns an associative array that holds a whole set of
 ...
 */
function iconv_mime_decode_headers (string $headers, int $mode = null, ?string $encoding = null): array|bool {}
 ...
 */
function iconv (string $from_encoding, string $to_encoding, string $string): string|bool {}
 ...
 * @return array|string|bool Returns the current value of the internal configuration variable if
 ...
 */
function iconv_get_encoding (string $type = "all"): array|string|bool {}
