 ...
 * <pre>
 * <code>&lt;?php
 * preg_match(&&#35;039;&#47;(foo)(bar)(baz)&#47;&&#35;039;, &&#35;039;foobarbaz&&#35;039;, $matches, PREG_OFFSET_CAPTURE);
 * print_r($matches);
 * ?&gt;</code>
 * </pre>
 ...
 * <pre>
 * <code>&lt;?php
 * preg_match(&&#35;039;&#47;(a)(b)&#42;(c)&#47;&&#35;039;, &&#35;039;ac&&#35;039;, $matches);
 * var_dump($matches);
 * preg_match(&&#35;039;&#47;(a)(b)&#42;(c)&#47;&&#35;039;, &&#35;039;ac&&#35;039;, $matches, PREG_UNMATCHED_AS_NULL);
 * var_dump($matches);
 * ?&gt;</code>
 * </pre>
 * <p>The above example will output:</p>
 ...
 * </p>
 * </p>
 * @return mixed preg_match returns 1 if the pattern
 ...
 * <code>&lt;?php
 * preg_match_all(
 * &&#35;039;&#47;(?J)(?&lt;match&gt;foo)|(?&lt;match&gt;bar)&#47;&&#35;039;,
 * &&#35;039;foo bar&&#35;039;,
 * $matches,
 * PREG_PATTERN_ORDER
 * );
 * print_r($matches[&&#35;039;match&&#35;039;]);
 * ?&gt;</code>
 * </pre>
 * <p>The above example will output:</p>
 * <pre>
 ...
 * <pre>
 * <code>&lt;?php
 * preg_match_all(&&#35;039;&#47;(foo)(bar)(baz)&#47;&&#35;039;, &&#35;039;foobarbaz&&#35;039;, $matches, PREG_OFFSET_CAPTURE);
 * print_r($matches);
 * ?&gt;</code>
 * </pre>
 * <p>The above example will output:</p>
 ...
 * for examples.
 * </p>
 * @return mixed the number of full pattern matches (which might be zero), or false on failure.
 */
 ...
 * $fp = fopen(&quot;php:&#47;&#47;stdin&quot;, &quot;r&quot;) or die(&quot;can&&#35;039;t read stdin&quot;);
 * while (!feof($fp)) {
 * $line = fgets($fp);
 ...
 * @param int $count [optional] If specified, this variable will be filled with the number of
 * replacements done.
 * @param int $flags [optional] flags can be a combination of the
 ...
 * </p>
 * </p>
 * @return mixed an array containing substrings of subject
 * split along boundaries matched by pattern, or false on failure.
 */
function preg_split (string $pattern, string $subject, int $limit = null, int $flags = null): array|false {}

/**
 * Quote regular expression characters
 * @link http://www.php.net/manual/en/function.preg-quote.php
 * @param string $str The input string.
 * @param mixed $delimiter [optional] If the optional delimiter is specified, it
 ...
 * the given pattern.
 * @return mixed an array indexed using the keys from the
