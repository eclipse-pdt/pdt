 ...
 * </p>
 */
function ldap_connect ($uri = null): LDAP\Connection|false {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_bind (LDAP\Connection $ldap, $dn = null, $password = null): bool {}
 ...
 */
function ldap_bind_ext (LDAP\Connection $ldap, $dn = null, $password = null, $controls = null): LDAP\Result|false {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_sasl_bind (LDAP\Connection $ldap, $dn = null, $password = null, $mech = null, $realm = null, $authc_id = null, $authz_id = null, $props = null): bool {}
 ...
 */
function ldap_read ($ldap, $base, $filter, array $attributes = null, int $attributes_only = null, int $sizelimit = null, int $timelimit = null, int $deref = null, $controls = null): LDAP\Result|array|false {}
 ...
 * @return mixed ldap.return-result-array
 */
function ldap_list ($ldap, $base, $filter, array $attributes = null, int $attributes_only = null, int $sizelimit = null, int $timelimit = null, int $deref = null, $controls = null): LDAP\Result|array|false {}
 ...
 * @return mixed ldap.return-result-array
 */
function ldap_search ($ldap, $base, $filter, array $attributes = null, int $attributes_only = null, int $sizelimit = null, int $timelimit = null, int $deref = null, $controls = null): LDAP\Result|array|false {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_add (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): bool {}
 ...
 * @return mixed ldap.return-result
 */
function ldap_add_ext (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): LDAP\Result|false {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_delete (LDAP\Connection $ldap, string $dn, $controls = null): bool {}
 ...
 * @return mixed ldap.return-result
 */
function ldap_delete_ext (LDAP\Connection $ldap, string $dn, $controls = null): LDAP\Result|false {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_modify_batch (LDAP\Connection $ldap, string $dn, array $modifications_info, $controls = null): bool {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_mod_add (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): bool {}
 ...
 * @return mixed ldap.return-result
 */
function ldap_mod_add_ext (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): LDAP\Result|false {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_mod_replace (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): bool {}
 ...
 * @return mixed ldap.return-result
 */
function ldap_mod_replace_ext (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): LDAP\Result|false {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_mod_del (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): bool {}
 ...
 * @return mixed ldap.return-result
 */
function ldap_mod_del_ext (LDAP\Connection $ldap, string $dn, array $entry, $controls = null): LDAP\Result|false {}
 ...
 */
function ldap_compare (LDAP\Connection $ldap, string $dn, string $attribute, string $value, $controls = null): int|bool {}
 ...
 * @return bool true on success or false on failure
 */
function ldap_rename (LDAP\Connection $ldap, string $dn, string $new_rdn, string $new_parent, bool $delete_old_rdn, $controls = null): bool {}
 ...
 * @return mixed ldap.return-result
 */
function ldap_rename_ext (LDAP\Connection $ldap, string $dn, string $new_rdn, string $new_parent, bool $delete_old_rdn, $controls = null): LDAP\Result|false {}
 ...
 * @return bool 
 */
function ldap_set_rebind_proc (LDAP\Connection $ldap, $callback): bool {}
 ...
 */
function ldap_exop (LDAP\Connection $ldap, string $request_oid, string $request_data = null, array $controls = null, string &$response_data = null, string &$response_oid = null): LDAP\Result|bool {}
 ...
 */
function ldap_exop_passwd (LDAP\Connection $ldap, string $user = null, string $old_password = null, string $new_password = null, array &$controls = null): string|bool {}
