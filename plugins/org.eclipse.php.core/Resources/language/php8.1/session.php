...
interface SessionHandlerInterface  {
	 ...
	 * @return string|bool Returns an encoded string of the read data. If nothing was read, it must return false. Note this value is returned internally to PHP for processing.
	 */
	abstract public function read (string $id): string|bool
	 ...
	 * @return int|bool Returns the number of deleted sessions on success, or false on failure.
 ...
 * @return string|bool Returns the name of the current session. If name is given
 * and function updates the session name, name of the old session
 * is returned, or false on failure.
 */
function session_name (?string $name = null): string|bool {}

/**
 * Get and/or set the current session module
 * @link http://www.php.net/manual/en/function.session-module-name.php
 * @param string|null $module [optional] 
 * @return string|bool Returns the name of the current session module, or false on failure.
 */
function session_module_name (?string $module = null): string|bool {}

/**
 * Get and/or set the current session save path
 * @link http://www.php.net/manual/en/function.session-save-path.php
 * @param string|null $path [optional] 
 * @return string|bool Returns the path of the current directory used for data storage, or false on failure.
 */
function session_save_path (?string $path = null): string|bool {}

/**
 * Get and/or set the current session id
 * @link http://www.php.net/manual/en/function.session-id.php
 * @param string|null $id [optional] 
 * @return string|bool session_id returns the session id for the current
 * session or the empty string ("") if there is no current
 * session (no current session id exists).
 * On failure, false is returned.
 */
function session_id (?string $id = null): string|bool {}

/**
 * Create new session id
 * @link http://www.php.net/manual/en/function.session-create-id.php
 * @param string $prefix [optional] 
 * @return string|bool session_create_id returns new collision free
 * session id for the current session. If it is used without active
 * session, it omits collision check.
 * On failure, false is returned.
 */
function session_create_id (string $prefix = ""): string|bool {}
 ...
 * @return string|bool Returns the contents of the current session encoded, or false on failure.
 */
function session_encode (): string|bool {}
 ...
 * @return int|bool session_gc returns number of deleted session
 ...
 * @return string|bool Returns the name of the current cache limiter.
 * On failure to change the value, false is returned.
 */
function session_cache_limiter (?string $value = null): string|bool {}
 ...
 * @return int|bool Returns the current setting of session.cache_expire.
 * The value returned should be read in minutes, defaults to 180.
 * On failure to change the value, false is returned.
 */
function session_cache_expire (?int $value = null): int|bool {}
