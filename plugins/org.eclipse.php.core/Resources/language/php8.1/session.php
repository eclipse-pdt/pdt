...
interface SessionHandlerInterface  {
	 ...
	 */
	abstract public function read (string $id): string|int;
	 ...
	 */
	abstract public function gc (int $max_lifetime): int;
...
class SessionHandler implements SessionHandlerInterface, SessionIdInterface {
	 ...
	 * @return string|false Returns an encoded string of the read data. If nothing was read, it must return false. Note this value is returned internally to PHP for processing.
	 */
	public function read (string $id): string|int {}
 ...
 */
function session_name (?string $name = null): string|int {}
 ...
 */
function session_module_name (?string $module = null): string|int {}
 ...
 */
function session_save_path (?string $path = null): string|int {}
 ...
 */
function session_id (?string $id = null): string|int {}
 ...
 * On failure, false is returned.
 */
function session_create_id (string $prefix = '""'): string|int {}
 ...
 */
function session_encode (): string|int {}
 ...
 */
function session_cache_limiter (?string $value = null): string|int {}
