...
// Start of tokenizer v.8.1.19

/**
 * This class provides an alternative to token_get_all. While the function returns tokens
 * either as a single-character string, or an array with a token ID, token text and line number,
 * PhpToken::tokenize normalizes all tokens into PhpToken objects, which makes code operating
