...
class XMLReader  {
	 ...
	 * @return mixed The value of the attribute, or null if no attribute with the given
	 ...
	 * @return mixed The value of the attribute, or null if no attribute exists at
	 ...
	 * @return mixed The value of the namespace, or null if no namespace exists.
	 */
	 ...
	 * @param mixed $name [optional] The name of the next node to move to.
	 * @return bool true on success or false on failure
	 */
	 ...
	 * @param mixed $encoding [optional] The document encoding or null.
	 * @param int $flags [optional] A bitmask of the LIBXML_&#42; 
	 * constants.
	 * @return mixed true on success or false on failure If called statically, returns an
	 * XMLReader or false on failure.
	 */
	public static function open (string $uri, $encoding = null, int $flags = null) {}
	 ...
	 * @param mixed $filename The filename of the XSD schema.
	 * @return bool true on success or false on failure
	 */
	 ...
	 * @param mixed $filename filename or URI pointing to a RelaxNG Schema.
	 * @return bool true on success or false on failure
	 */
	 ...
	 * @param mixed $source String containing the RelaxNG Schema.
	 * @return bool true on success or false on failure
	 */
	 ...
	 * XMLReader or false on failure.
	 */
	public static function XML (string $source, $encoding = null, int $flags = null) {}

	/**
	 * Returns a copy of the current node as a DOM object
	 * @link http://www.php.net/manual/en/xmlreader.expand.php
	 * @param mixed $baseNode [optional] A DOMNode defining the target DOMDocument for the created DOM object.
	 * @return mixed The resulting DOMNode or false on error.
	 */
	public function expand ($baseNode = null) {}

}
// End of xmlreader v.8.1.19
