 ...
 */
function ssh2_forward_listen (resource $session, int $port, string $host = null, int $max_connections = 16): resource|false {}
 ...
 */
function ssh2_forward_accept (resource $listener): resource|false {}
 ...
 */
function ssh2_shell (resource $session, string $termtype = "vanilla", ?array $env = null, int $width = 80, int $height = 25, int $width_height_type = SSH2_TERM_UNIT_CHARS): resource|false {}
 ...
 */
function ssh2_exec (resource $session, string $command, string $pty = null, array $env = null, int $width = 80, int $height = 25, int $width_height_type = SSH2_TERM_UNIT_CHARS): resource|false {}
