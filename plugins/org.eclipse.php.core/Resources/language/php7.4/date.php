...
class DateTime implements DateTimeInterface {
	 ...
	 * @param DateTimeImmutable $datetime The immutable DateTimeImmutable object that needs
...
class DateTimeZone  {
	 ...
	 * @param int $what [optional] One of the DateTimeZone class constants (or a combination).
...
class DatePeriod implements Traversable {
	 ...
	 * @return int the number of recurrences.
	 */
