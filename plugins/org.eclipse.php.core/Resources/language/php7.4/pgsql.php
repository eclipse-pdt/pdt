 ...
 * @param mixed $field_name_or_number [optional]
 */
...
/**
 * @param mixed $connection [optional]
 * @param mixed $large_object_id [optional]
 */
function pg_locreate ($connection = null, $large_object_id = null) {}

/**
 * @param mixed $connection [optional]
 * @param mixed $large_object_oid [optional]
 */
