...
class NumberFormatter  {
	 ...
	 * @return string String representing the formatted currency value, or false on failure.
	 */
...
class IntlChar  {
	 ...
	 * </p>
	 * </p>
	 * @return int The Unicode value of the code point with the given name (as an integer), or null if there is no such code point.
	 */
