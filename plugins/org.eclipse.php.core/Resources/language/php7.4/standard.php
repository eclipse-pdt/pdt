 ...
 * @param string $haystack The string to search in.
 * @param mixed $needle strings.parameter.needle.non-string
 ...
 * greater than the length of main_str, or the
 ...
 */
function sprintf (string $format, $_ = null) {}
 ...
 */
function printf (string $format, $_ = null) {}
 ...
 */
function fprintf ($handle, string $format, $_ = null) {}
 ...
 */
function call_user_func (callable $callback, $_ = null) {}
 ...
 * @return void 
 */
function register_shutdown_function (callable $callback, $_ = null) {}
 ...
 * @return bool true on success or false on failure
 */
function register_tick_function (callable $function, $_ = null) {}
 ...
 * @return int the number of bytes read from the file on success,
 * or false on failure
 */
 ...
 * @param resource $handle fs.validfp.all
 * @param int $length [optional] Reading ends when length - 1 bytes have been
 ...
 */
function pack (string $format, $_ = null) {}
 ...
 * the manual.
 * @return resource a directory handle resource on success,
 * or false on failure
 */
 ...
 */
function array_merge (array $_ = null) {}
