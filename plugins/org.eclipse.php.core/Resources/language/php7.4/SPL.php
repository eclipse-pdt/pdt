...
class SplFileObject extends SplFileInfo implements RecursiveIterator, Traversable, Iterator, SeekableIterator {
	 ...
	 * The escape character (at most one character). Defaults as a backslash (\) or the value set using SplFileObject::setCsvControl.
	 ...
	 * @param string $escape [optional] The field escape character (at most one character).
	 * An empty string ("") disables the proprietary escape mechanism.
	 * @return void 
	 */
