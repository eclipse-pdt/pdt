 ...
 * @param int $method [optional] Allows Easter dates to be calculated based on the Julian calendar when set
 * to CAL_EASTER_ALWAYS_JULIAN. See also calendar constants.
 * @return int The easter date as a unix timestamp.
 */
function easter_date (int $year = null, int $method = null) {}
