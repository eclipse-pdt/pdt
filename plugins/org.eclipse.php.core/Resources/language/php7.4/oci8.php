 ...
 * @param $column_name
 * @param $variable
 * @param mixed $maximum_length [optional]
 * @param mixed $type [optional]
 */
 ...
 * @param mixed $maximum_rows [optional]
 ...
 * @param $username
 * @param $password
 * @param mixed $connection_string [optional]
 * @param mixed $character_set [optional]
 * @param mixed $session_mode [optional]
 */
 ...
 * @param mixed $connection_or_statement_resource [optional]
 */
 ...
 * @param $connection_resource
 * @param $type_name
 * @param mixed $schema_name [optional]
 */
