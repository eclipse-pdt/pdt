 ...
 * @param mixed $value
 */
function curl_multi_setopt (CurlMultiHandle $multi_handle, int $option, mixed $value = null): bool {}
 ...
 * {@inheritdoc}
 * @param CurlMultiHandle $multi_handle
 * @param mixed $still_running
 */
function curl_multi_exec (CurlMultiHandle $multi_handle, &$still_running = null): int {}
 ...
 * {@inheritdoc}
 * @param CurlMultiHandle $multi_handle
 * @param mixed $queued_messages [optional]
 */
 ...
 * @param mixed $value
 */
function curl_setopt (CurlHandle $handle, int $option, mixed $value = null): bool {}
 ...
 * @param mixed $value
 */
function curl_share_setopt (CurlShareHandle $share_handle, int $option, mixed $value = null): bool {}
