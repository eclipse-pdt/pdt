 ...
 * @return bool Return true if the terminal has color capabilities, false otherwise.
 */
 ...
 * the terminal has color changing capabilities.
 * </p>
 * @return int -1 if the function was successful, and
 * 0 if ncurses or color support were not initialized.
 */
 ...
 * @return int 0 on success, or -1 if the
 ...
 * @return bool true, if ncurses_end has been called
 ...
 * @param format int <p>
 * If ncurses_init eventually uses a line from
 ...
 * </p>
 * @return int -1 if the function was successful,
...
/**
 * no color (black)
 * @link http://php.net/manual/en/ncurses.constants.php
 */
