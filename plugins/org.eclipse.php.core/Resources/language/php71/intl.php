...
class IntlTimeZone  {
	 ...
	 * @return string 
	 */
	public static function getEquivalentID (string $zoneId, $index) {}
	 ...
	 * @return string 
	 */
	public function getDisplayName (bool $isDaylight = null, $style = null, string $locale = null) {}
...
class IntlCalendar  {
	 ...
	 */
	public static function getKeywordValuesForLocale (string $key, string $locale, $commonlyUsed) {}
...
class UConverter  {
	 ...
	 * @return mixed 
	 */
	public function toUCallback ($reason, string $source, string $codeUnits, &$error) {}
	 ...
	 * @return mixed 
	 */
	public function fromUCallback ($reason, string $source, string $codePoint, &$error) {}
