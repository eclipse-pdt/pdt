...
class Locale  {
	 ...
	 * @param array $langtag An array containing a list of language tags to compare to 
...
class IntlChar  {
	 ...
	 * @param int $nameChoice [optional] Selector for which kind of names to enumerate. Can be any of these constants:
	 * IntlChar::UNICODE_CHAR_NAME (default)
	 * IntlChar::UNICODE_10_CHAR_NAME
	 * IntlChar::EXTENDED_CHAR_NAME
	 * IntlChar::CHAR_NAME_ALIAS
