 ...
 * @param int $options [optional] The options are a bit mask with one or more of
 * the following:
 * <br>
 ...
 * @param array $params [optional] Connection parameters, the following (string) keys maybe used 
 ...
 * @param resource $imap_stream 
 * @param int $msg_number The message number
 * @param int $options [optional] The optional options are a bit mask
 ...
 * @param resource $imap_stream 
 * @param int $msg_number The message number
 * @param int $options [optional] The possible options are:
 * <br>
 * FT_UID - The msgno
 * argument is a UID
 * <br>
 ...
 * @param string $mailbox The mailbox name, see imap_open for more
 * information
 * @param int $options [optional] options is a bitmask of one or more of
 * <br>
 ...
 * @param string $mailbox The mailbox name, see imap_open for more
 * information
 * @param int $options [optional] options is a bitmask and may contain the single option:
 * <br>
 * CP_UID - the sequence numbers contain UIDS
 * @return bool true on success or false on failure
 */
 ...
 * defined by RFC2060.
 * @param int $options [optional] A bit mask that may contain the single option:
 * <br>
 ...
 * @param int $options [optional] options are a bit mask and may contain
 * the single option:
 * <br>
 * ST_UID - The sequence argument contains UIDs
 * instead of sequence numbers
 ...
 * @param int $options [optional] The options are a bitmask of one or more of the
 * following:
 * <br>
