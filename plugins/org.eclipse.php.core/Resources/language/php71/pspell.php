 ...
 * using.
 * @param int $mode [optional] The mode parameter is the mode in which spellchecker will work.
 ...
 * machine unsigned 32.
 * @param int $mode [optional] The mode in which spellchecker will work. There are several modes available:
 * <br>
 * PSPELL_FAST - Fast mode (least number of
 * suggestions)
 * <br>
