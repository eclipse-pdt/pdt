 ...
 * @param array $imageinfo [optional] This optional parameter allows you to extract some extended
 ...
 * @param string $mode [optional] mode is a single character that defines what
 ...
 * @param string $haystack The string to search in.
 * @param string $needle If needle is not a string, it is converted
 * to an integer and applied as the ordinal value of a character.
 ...
 * </p>
 */
function strrpos (string $haystack, string $needle, int $offset = null) {}
 ...
 * @param int $format [optional] Specify the return value of this function. The current supported values
 * are:
 * <br>
 ...
 * <br><p>a % character</p>
 * <br><p>optional flags</p>
 * <br><p>optional field width</p>
 * <br><p>optional left precision</p>
 * <br><p>optional right precision</p>
 * <br><p>a required conversion character</p>
 * </p>
 * Flags
 * <p>
 ...
 * @param int $category category is a named constant specifying the
 ...
 * @param string $format The interpreted format for str, which is
 ...
 * @param array $other_options [optional] Allows you to specify additional options. Currently supported options
 * include:
 ...
 */
function setcookie (string $name, string $value = null, int $expire = null, string $path = null, string $domain = null, bool $secure = null, bool $httponly = null) {}
 ...
 * @return bool true on success or false on failure
 */
function setrawcookie (string $name, string $value = null, int $expire = null, string $path = null, string $domain = null, bool $secure = null, bool $httponly = null) {}
 ...
 * to SEEK_END.
 * </p>
 * @param int $whence [optional] whence values are:
 ...
 * </p>
 * &tip.fopen-wrapper;
 * @param int $flags [optional] The optional parameter flags can be one, or
 ...
 * @param mixed $params [optional] This filter will be added with the specified params
 ...
 * @param array $array The input array.
 * @param mixed $value1 The first value to push onto the end of the array.
 * @param mixed $_ [optional] 
