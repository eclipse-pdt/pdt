 ...
 * @param string $connection_string 
 * @param int $flags [optional] 
 * @return PgSql\Connection|false Returns a PgSql\Connection instance on success, or false on failure.
 */
 ...
 */
function pg_fetch_result (PgSql\Result $result, string|false|null $row, mixed $field): string|false|null {}
 ...
 */
function pg_field_prtlen (PgSql\Result $result, string|false|null $row, mixed $field_name_or_number): int {}
 ...
 */
function pg_field_is_null (PgSql\Result $result, string|false|null $row, mixed $field): int {}
 ...
 * @return bool Returns true on success or false on failure.
 */
function pg_trace (string $filename, string $mode = '"w"', ?PgSql\Connection $connection = null, int $trace_mode = null): bool {}
 ...
 * @param mixed $object_id [optional] 
 * @return int|string|false The OID of the newly created large object, or false on failure.
 */
function pg_lo_import (PgSql\Connection $connection = null, string $pathname, mixed $object_id = null): int|string|false {}
 ...
 * and pg_result_error
 * @link http://www.php.net/manual/en/function.pg-set-error-context-visibility.php
 * @param PgSql\Connection $connection 
 * @param int $visibility 
 * @return int The previous visibility level: PGSQL_SHOW_CONTEXT_NEVER,
 ...
 * @link http://www.php.net/manual/en/function.pg-result-memory-size.php
 ...
 */
function pg_socket_poll ($socket = null, int $read, int $write, int $timeout = -1): int {}

/**
 * Set the query results to be retrieved in chunk mode
 * @link http://www.php.net/manual/en/function.pg-set-chunked-rows-size.php
 * @param PgSql\Connection $connection >An PgSql\Connection instance.
 ...
 * @var string
 */
define ('PGSQL_LIBPQ_VERSION', 17.6);
 ...
 * @var string
 */
define ('PGSQL_LIBPQ_VERSION_STR', 17.6);
 ...
 * Returned for SELECT commands when
 * pg_set_chunked_rows_size is set.
...
/**
 * To be used with pg_set_error_context_visibility,
