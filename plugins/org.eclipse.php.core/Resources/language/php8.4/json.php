 ...
 * @param int $depth [optional] 
 * @param int $flags [optional] 
 * @return mixed Returns the value encoded in json as an appropriate
 ...
 * @link http://www.php.net/manual/en/function.json-validate.php
 * @param string $json 
 * @param int $depth [optional] 
 * @param int $flags [optional] 
 * @return bool Returns true if the given string is syntactically valid JSON, otherwise
 * returns false.
 */
function json_validate (string $json, int $depth = 512, int $flags = null): bool {}
