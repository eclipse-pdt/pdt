...
final class tidyNode  {
	 ...
	 * @link http://www.php.net/manual/en/tidynode.getprevioussibling.php
	 * @return tidyNode|null Returns a tidyNode if the node has a previous sibling, or null
	 * otherwise.
	 */
	 ...
	 * @link http://www.php.net/manual/en/tidynode.getnextsibling.php
	 * @return tidyNode|null Returns a tidyNode if the node has a next sibling, or null
	 * otherwise.
	 */
