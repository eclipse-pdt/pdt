...
class PDO  {
	 ...
	 * One of the PDO::ATTR_&#42; constants. The generic attributes that
	 ...
	 * Note that driver specific attributes must not be used
	 * with other drivers.
	 ...
	 * @param mixed $name [optional] Name of the sequence object from which the ID should be returned.
	 ...
	 * @param array $options [optional] This array holds one or more key=&gt;value pairs to set
	 ...
	 * </p>
	 * <p>
	 * If the SQL contains placeholders, PDO::prepare and 
	 * PDOStatement::execute must be used instead.
	 * Alternatively, the SQL can be prepared manually before calling 
	 * PDO::query, with the data properly formatted using
	 * PDO::quote if the driver supports it.
	 * </p>
	 * @param mixed $fetchMode [optional] <p>
	 ...
	 * @param int $type [optional] Provides a hint to the type of data for drivers that have alternate quoting
	 * styles. For example PDO_PARAM_LOB will tell the driver to
	 * escape binary data.
	 * @return mixed a quoted string that is theoretically safe to pass into an
	 * SQL statement. Returns false if the driver does not support quoting in
	 * this way.
	 */
	public function quote (string $string, int $type = null) {}
...
class PDOStatement implements IteratorAggregate, Traversable {
	 ...
	 * @return bool true on success or false on failure
	 */
	public function bindColumn ($column, &$var, int $type = null, int $maxLength = null, $driverOptions = null) {}
	 ...
	 * length.
	 * Meaningful only when type parameter is PDO::PARAM_INPUT_OUTPUT.
	 * @param mixed $driverOptions [optional] 
	 * @return bool true on success or false on failure
	 */
	public function bindParam ($param, &$var, int $type = null, int $maxLength = null, $driverOptions = null) {}
	 ...
	 * @return mixed null, or false in case of an error.
	 */
	 ...
	 * params than in the SQL specified 
	 ...
	 * </p>
	 * </p>
	 * @param int $cursorOrientation [optional] For a PDOStatement object representing a scrollable cursor, this
	 ...
	 * @param int $cursorOffset [optional] <p> 
	 ...
	 */
	public function fetch (int $mode = null, int $cursorOrientation = null, int $cursorOffset = null) {}
	 ...
	 * </p>
	 */
	public function fetchAll (int $mode = null) {}

	/**
	 * Returns a single column from the next row of a result set
	 * @link http://www.php.net/manual/en/pdostatement.fetchcolumn.php
	 * @param int $column [optional] 0-indexed number of the column you wish to retrieve from the row. If
	 ...
	 * @param mixed $class [optional] Name of the created class.
	 * @param array $constructorArgs [optional] Elements of this array are passed to the constructor.
	 ...
	 */
	public function fetchObject ($class = null, array $constructorArgs = null) {}
	 ...
	 * @return mixed an associative array containing the following values representing
