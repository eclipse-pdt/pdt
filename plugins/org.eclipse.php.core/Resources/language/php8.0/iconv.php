 ...
 */
function iconv_substr (string $string, int $offset, ?int $length = null, ?string $encoding = null): string|int {}
 ...
 */
function iconv_strpos (string $haystack, string $needle, int $offset = null, ?string $encoding = null): int {}
 ...
 * or false if an error occurs during the encoding.
 */
function iconv_mime_encode (string $field_name, string $field_value, array $options = '[]'): string|int {}
 ...
 */
function iconv_mime_decode (string $string, int $mode = null, ?string $encoding = null): string|int {}
 ...
 */
function iconv_mime_decode_headers (string $headers, int $mode = null, ?string $encoding = null): array|int {}
 ...
 */
function iconv (string $from_encoding, string $to_encoding, string $string): string|int {}
 ...
 */
function iconv_get_encoding (string $type = '"all"'): array|string|int {}
