 ...
 * param_name.
 */
function pg_parameter_status ($connection = null, string $param_name): string|false {}
 ...
 */
function pg_last_notice ($connection, int $mode = null): array|string|bool {}
 ...
 */
function pg_field_table ($result, int $field, bool $oid_only = null): string|int|false {}
 ...
 * </p>
 */
function pg_fetch_row ($result, $row = null, int $mode = null): array|false {}
 ...
 * </p>
 */
function pg_fetch_assoc ($result, $row = null): array|false {}
 ...
 * </p>
 */
function pg_fetch_array ($result, $row = null, int $mode = null): array|false {}
 ...
 * </p>
 */
function pg_fetch_object ($result, $row = null, string $class = null, array $constructor_args = null): object|false {}
 ...
 */
function pg_fetch_all ($result, int $mode = null): array {}
 ...
 */
function pg_field_prtlen ($result, int $row_number, $field_name_or_number): int|false {}
 ...
 */
function pg_field_is_null ($result, int $row, $field): int|false {}
 ...
 * @deprecated 
 */
function pg_getlastoid ($result = null): string|int|false {}
 ...
 */
function pg_lo_create ($connection = null, $object_id = null): string|int|false {}
 ...
 */
function pg_lo_read ($lob, int $length = null): string|false {}
 ...
 */
function pg_lo_write ($lob, string $data, $length = null): int|false {}
 ...
 */
function pg_lo_import ($connection = null, string $pathname, $object_id = null): string|int|false {}
 ...
 * @return bool true on success or false on failure
 */
function pg_lo_seek ($lob, int $offset, int $whence = null): bool {}
 ...
 * or PGSQL_ERRORS_VERBOSE.
 */
function pg_set_error_verbosity ($connection = null, int $verbosity): int|false {}
 ...
 */
function pg_copy_to ($connection, string $table_name, string $separator = null, string $null_as = null): array|false {}
 ...
 * @return bool true on success or false on failure
 */
function pg_copy_from ($connection, string $table_name, array $rows, string $separator = null, string $null_as = null): bool {}
 ...
 * @return string A string containing the escaped data.
 */
function pg_escape_literal ($connection = null, string $data): string|false {}
 ...
 * @return string A string containing the escaped data.
 */
function pg_escape_identifier ($connection = null, string $data): string|false {}
 ...
 */
function pg_result_status ($result, int $mode = null): string|int {}
 ...
 */
function pg_get_notify ($connection, int $mode = null): array|false {}
 ...
 */
function pg_meta_data ($connection, string $table_name, bool $extended = null): array|false {}
 ...
 */
function pg_convert ($connection, string $table_name, array $values, int $flags = null): array|false {}
 ...
 * via flags.
 */
function pg_insert ($connection, string $table_name, array $values, int $flags = null) {}
 ...
 * via flags.
 */
function pg_update ($connection, string $table_name, array $values, array $conditions, int $flags = null): string|bool {}
 ...
 * via flags.
 */
function pg_delete ($connection, string $table_name, array $conditions, int $flags = null): string|bool {}
 ...
 */
function pg_select ($connection, string $table_name, array $conditions, int $flags = null, int $mode = null): array|string|false {}
