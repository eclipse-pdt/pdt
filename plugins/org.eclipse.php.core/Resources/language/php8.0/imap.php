 ...
 * @return resource|false Returns an IMAP\Connection instance on success, or false on failure.
 */
function imap_open (string $mailbox, string $user, string $password, int $flags = null, int $retries = null, array $options = '[]') {}
 ...
 */
function imap_reopen ($imap, string $mailbox, int $flags = null, int $retries = null): bool {}
 ...
 */
function imap_close ($imap, int $flags = null): bool {}
 ...
 */
function imap_headers ($imap): array|int {}
 ...
 * </p>
 */
function imap_headerinfo ($imap, int $message_num, int $from_length = null, int $subject_length = null): stdClass|int {}
 ...
 */
function imap_body ($imap, int $message_num, int $flags = null): string|int {}
 ...
 * @return string|false Returns the body of the specified message, as a string, or false on failure.
 */
function imap_fetchtext ($imap, int $message_num, int $flags = null): string|int {}
 ...
 * imap_fetchstructure.
 */
function imap_bodystruct ($imap, int $message_num, string $section): stdClass|int {}
 ...
 */
function imap_fetchbody ($imap, int $message_num, string $section, int $flags = null): string|int {}
 ...
 * text string, or false on failure.
 */
function imap_fetchmime ($imap, int $message_num, string $section, int $flags = null): string|int {}
 ...
 * @return bool Returns true on success or false on failure.
 */
function imap_savebody ($imap, $file, int $message_num, string $section = '""', int $flags = null): bool {}
 ...
 */
function imap_fetchheader ($imap, int $message_num, int $flags = null): string|int {}
 ...
 * </table></p>
 */
function imap_fetchstructure ($imap, int $message_num, int $flags = null): stdClass|int {}
 ...
 * @return bool Returns true.
 */
function imap_delete ($imap, string $message_nums, int $flags = null): bool {}
 ...
 * @return bool Returns true on success or false on failure.
 */
function imap_undelete ($imap, string $message_nums, int $flags = null): bool {}
 ...
 */
function imap_check ($imap): stdClass|int {}
 ...
 */
function imap_listscan ($imap, string $reference, string $pattern, string $content): array|int {}
 ...
 * content in the text of the mailbox, or false on failure.
 */
function imap_scan ($imap, string $reference, string $pattern, string $content): array|int {}
 ...
 * content in the text of the mailbox, or false on failure.
 */
function imap_scanmailbox ($imap, string $reference, string $pattern, string $content): array|int {}
 ...
 * @return bool Returns true on success or false on failure.
 */
function imap_mail_copy ($imap, string $message_nums, string $mailbox, int $flags = null): bool {}
 ...
 * @return bool Returns true on success or false on failure.
 */
function imap_mail_move ($imap, string $message_nums, string $mailbox, int $flags = null): bool {}
 ...
 */
function imap_status ($imap, string $mailbox, int $flags): stdClass|int {}
 ...
 * @return bool Returns true on success or false on failure.
 */
function imap_setflag_full ($imap, string $sequence, string $flag, int $options = null): bool {}
 ...
 * @return bool Returns true on success or false on failure.
 */
function imap_clearflag_full ($imap, string $sequence, string $flag, int $options = null): bool {}
 ...
 */
function imap_sort ($imap, int $criteria, bool $reverse, int $flags = null, ?string $search_criteria = null, ?string $charset = null): array|int {}
 ...
 */
function imap_list ($imap, string $reference, string $pattern): array|int {}
 ...
 * @return array|false Returns an array containing the names of the mailboxes or false in case of failure.
 */
function imap_listmailbox ($imap, string $reference, string $pattern): array|int {}
 ...
 */
function imap_lsub ($imap, string $reference, string $pattern): array|int {}
 ...
 * @return array|false Returns an array of all the subscribed mailboxes, or false on failure.
 */
function imap_listsubscribed ($imap, string $reference, string $pattern): array|int {}
 ...
 */
function imap_getsubscribed ($imap, string $reference, string $pattern): array|int {}
 ...
 */
function imap_getmailboxes ($imap, string $reference, string $pattern): array|int {}
 ...
 * The function returns false on failure.
 */
function imap_fetch_overview ($imap, string $sequence, int $flags = null): array|int {}
 ...
 */
function imap_search ($imap, string $criteria, int $flags = SE_FREE, string $charset = '""'): array|int {}
 ...
 */
function imap_thread ($imap, int $flags = SE_FREE): array|int {}
 ...
 */
function imap_get_quota ($imap, string $quota_root): array|int {}
 ...
 * from the server.</p>
 */
function imap_get_quotaroot ($imap, string $mailbox): array|int {}
 ...
 */
function imap_getacl ($imap, string $mailbox): array|int {}
