 ...
 */
function imap_open (string $mailbox, string $user, string $password, int $flags = null, int $retries = null, array $options = null) {}
 ...
 * </p>
 */
function imap_headerinfo ($imap, int $message_num, int $from_length = null, int $subject_length = null): stdClass|false {}
 ...
 */
function imap_body ($imap, int $message_num, int $flags = null): string|false {}
 ...
 */
function imap_fetchtext ($imap = null, int $message_num, int $flags = 0): string|false {}
 ...
 */
function imap_fetchbody ($imap, int $message_num, string $section, int $flags = null): string|false {}
 ...
 * text string, or false on failure.
 */
function imap_fetchmime ($imap, int $message_num, string $section, int $flags = null): string|false {}
 ...
 * @return bool true on success or false on failure
 */
function imap_savebody ($imap, $file, int $message_num, string $section = null, int $flags = null): bool {}
 ...
 */
function imap_fetchheader ($imap, int $message_num, int $flags = null): string|false {}
 ...
 * </p>
 */
function imap_fetchstructure ($imap, int $message_num, int $flags = null): stdClass|false {}
 ...
 */
function imap_scan ($imap = null, string $reference, string $pattern, string $content): array|false {}
 ...
 * @param string $content
 */
function imap_scanmailbox ($imap = null, string $reference, string $pattern, string $content): array|false {}
 ...
 */
function imap_create ($imap = null, string $mailbox): bool {}
 ...
 * @param string $to
 */
function imap_rename ($imap = null, string $from, string $to): bool {}
 ...
 * @return bool true on success or false on failure
 */
function imap_append ($imap, string $folder, string $message, $options = null, $internal_date = null): bool {}
 ...
 */
function imap_sort ($imap, int $criteria, bool $reverse, int $flags = null, $search_criteria = null, $charset = null): array|false {}
 ...
 * @param string $pattern
 */
function imap_listmailbox ($imap = null, string $reference, string $pattern): array|false {}
 ...
 * @param string $pattern
 */
function imap_listsubscribed ($imap = null, string $reference, string $pattern): array|false {}
 ...
 * The function returns false on failure.
 */
function imap_fetch_overview ($imap, string $sequence, int $flags = null): array|false {}
 ...
 * </p>
 */
function imap_search ($imap, string $criteria, int $flags = null, string $charset = null): array|false {}
 ...
 * </p>
 */
function imap_thread ($imap, int $flags = null): array|false {}
