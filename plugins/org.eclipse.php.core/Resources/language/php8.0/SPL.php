 ...
 */
class CachingIterator extends IteratorIterator implements Stringable, OuterIterator, Traversable, Iterator, ArrayAccess, Countable {
 ...
 */
class RecursiveCachingIterator extends CachingIterator implements Countable, ArrayAccess, Iterator, Traversable, OuterIterator, Stringable, RecursiveIterator {
	const CALL_TOSTRING = 1;
	const CATCH_GET_CHILD = 16;
	const TOSTRING_USE_KEY = 2;
	const TOSTRING_USE_CURRENT = 4;
 ...
 */
class DirectoryIterator extends SplFileInfo implements Stringable, Iterator, Traversable, SeekableIterator {
 ...
 */
class FilesystemIterator extends DirectoryIterator implements SeekableIterator, Traversable, Iterator, Stringable {
 ...
 */
class RecursiveDirectoryIterator extends FilesystemIterator implements Stringable, Iterator, Traversable, SeekableIterator, RecursiveIterator {
	const CURRENT_MODE_MASK = 240;
	const CURRENT_AS_PATHNAME = 32;
	const CURRENT_AS_FILEINFO = 0;
	const CURRENT_AS_SELF = 16;
 ...
 */
class GlobIterator extends FilesystemIterator implements Stringable, Iterator, Traversable, SeekableIterator, Countable {
	const CURRENT_MODE_MASK = 240;
	const CURRENT_AS_PATHNAME = 32;
	const CURRENT_AS_FILEINFO = 0;
	const CURRENT_AS_SELF = 16;
 ...
 */
class SplFixedArray implements IteratorAggregate, Traversable, ArrayAccess, Countable {
