 ...
 * @param mixed $read The sockets listed in the read array will be
 ...
 * @param mixed $write The sockets listed in the write array will be
 * watched to see if a write will not block.
 * @param mixed $except The sockets listed in the except array will be
 * watched for exceptions.
 * @param mixed $seconds The seconds and microseconds
 ...
 * </p>
 */
function socket_select (&$read, &$write, &$except, $seconds, int $microseconds = null): int|false {}
 ...
 * @return mixed socket_create_listen returns a new Socket instance
 * on success or false on error. The error code can be retrieved with
 * socket_last_error. This code may be passed to
 * socket_strerror to get a textual explanation of the
 * error.
 */
function socket_create_listen (int $port, int $backlog = null): Socket|false {}
 ...
 * @return mixed a new Socket instance on success, or false on error. The actual
 ...
 * @param mixed $length [optional] The optional parameter length can specify an
 * alternate length of bytes written to the socket. If this length is
 * greater than the buffer length, it is silently truncated to the length
 * of the buffer.
 * @return mixed the number of bytes successfully written to the socket or false on failure.
 ...
 * </p>
 */
function socket_write (Socket $socket, string $data, $length = null): int|false {}
 ...
 * </p>
 * </p>
 * @return mixed socket_read returns the data as a string on success,
 ...
 * </p>
 */
function socket_read (Socket $socket, int $length, int $mode = null): string|false {}
 ...
 * </table>
 * </table>
 * @return mixed socket_create returns a Socket instance on success,
 ...
 * AF_UNIX.
 * @param mixed $port [optional] The port parameter is only used and is mandatory
 ...
 * </p>
 */
function socket_connect (Socket $socket, string $address, $port = null): bool {}

/**
 * Return a string describing a socket error
 * @link http://www.php.net/manual/en/function.socket-strerror.php
 * @param int $error_code A valid socket error number, likely produced by 
 * socket_last_error.
 * @return string the error message associated with the error_code
 * parameter.
 */
 ...
 * @param Socket $socket The socket must be a Socket instance previously
 * created by socket_create().
 * @param mixed $data The data received will be fetched to the variable specified with
 ...
 * @param Socket $socket The socket must be a Socket instance previously
 * created by socket_create().
 * @param string $data The data received will be fetched to the variable specified with
 * data.
 * @param int $length Up to length bytes will be fetched from remote host.
 * @param int $flags <p>
 * The value of flags can be any combination of 
 ...
 * </table>
 * </table>
 * @param string $address If the socket is of the type AF_UNIX type,
 ...
 * port will be null.
 * @return mixed socket_recvfrom returns the number of bytes received,
 * or false if there was an error. The actual error code can be retrieved by 
 * calling socket_last_error. This error code may be
 * passed to socket_strerror to get a textual explanation
 * of the error.
 ...
 * @param mixed $port [optional] port is the remote port number at which the data
 * will be sent.
 * @return mixed socket_sendto returns the number of bytes sent to the
 * remote host, or false if an error occurred.
 */
function socket_sendto (Socket $socket, string $data, int $length, int $flags, string $address, $port = null): int|false {}
 ...
 * </table>
 * </table>
 * @return mixed the value of the given option, or false on failure.
 */
 ...
 * @param Socket $socket A Socket instance created with socket_create.
 * @param int $mode [optional] The value of mode can be one of the following:
 * <table>
 ...
 * @return bool true on success or false on failure
 */
function socket_shutdown (Socket $socket, int $mode = null): bool {}

/**
 * Returns the last error on the socket
 * @link http://www.php.net/manual/en/function.socket-last-error.php
 * @param mixed $socket [optional] A Socket instance created with socket_create.
 ...
 * @param Socket $socket 
 * @return mixed Return resource or false on failure.
 */
 ...
 * @return mixed the number of bytes sent, or false on failure.
 */
 ...
 * @param mixed $service [optional] The service to connect to. If service is a numeric string, it designates the port.
 ...
 * @return mixed an array of AddressInfo instances that can be used with the other socket_addrinfo functions.
 * On failure, false is returned.
 */
function socket_addrinfo_lookup (string $host, $service = null, array $hints = null): array|false {}
 ...
 * @return mixed a Socket instance on success or false on failure.
 */
