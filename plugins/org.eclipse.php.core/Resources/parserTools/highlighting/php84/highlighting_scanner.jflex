...
package org.eclipse.php.internal.core.documentModel.parser.php84;
...
<ST_PHP_IN_SCRIPTING>"enum" {
	return PHP_ENUM;
}

<ST_PHP_IN_SCRIPTING>"never" {
	return PHP_NEVER;
}
