...
public abstract class PHPASTVisitor extends ASTVisitor {
	...
	public boolean endvisit(ASTNode s) throws Exception {
		...
		// php8.1
		if (nodeClass.equals(PHPAsCallableArgumentsList.class)) {
			return endvisit((PHPAsCallableArgumentsList) s);
		}
	...
	public boolean visit(ASTNode s) throws Exception {
		...
		if (nodeClass.equals(PHPAsCallableArgumentsList.class)) {
			return visit((PHPAsCallableArgumentsList) s);
		}
	...
	public boolean endvisit(PHPAsCallableArgumentsList s) throws Exception {
		endvisitGeneral(s);
		return false;
	}
	// php8.1 ends
	...
	public boolean endvisit(ReflectionConstantAccess s) throws Exception {
		endvisitGeneral(s);
		return false;
	}
	// php8.3 ends
