...
import org.eclipse.php.core.util.WeakObject;
...
public class WeakCollection implements Collection {
    ...
    /**
     * Returns the number of referenced elements in this collection.
     ...
     * weak iterator that while iterating the collection removes the unreferenced objects.
     */
    ...
    /**
     * This class provides an implementation for the iterator interface.
     * The class returns only those objects that are still valid (were not collected
    ...
    private class WeakIterator implements Iterator {
        ...
        /**
         * We can't delegate to the hasNext() method of referencedIterator because there
         * is a possibility that all of the remaining objects in it are garbage collected.
         * Instead we're checking the next returnable object that will be returned in
         * the next next() method.
         */
        ...
        /**
         * We check that nextObject is non null in case there is a next() call after
         * a next() call without hasNext() in between.
         */
        public Object next() {
            if (nextObject == null) {
                nextObject = nextImpl();
        ...
        /**
         * This method gets the next non null object from the referenced collection.
         */
