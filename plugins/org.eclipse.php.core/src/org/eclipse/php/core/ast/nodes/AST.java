...
public class AST {
	...
	private AstLexer getLexerInstance(Reader reader, PHPVersion phpVersion, boolean aspTagsAsPhp, boolean useShortTags)
		...
		if (PHPVersion.PHP5 == phpVersion) {
			...
			final AstLexer lexer80 = getLexer80(reader);
			lexer80.setUseAspTagsAsPHP(aspTagsAsPhp);
			lexer80.setUseShortTags(useShortTags);
			return lexer80;
			...
			final AstLexer lexer83 = getLexer83(reader);
	...
	private AstLexer getLexer83(Reader reader) throws IOException {
		final org.eclipse.php.internal.core.ast.scanner.php83.PHPAstLexer phpAstLexer = new org.eclipse.php.internal.core.ast.scanner.php83.PHPAstLexer(
				reader);
		phpAstLexer.setAST(this);
		return phpAstLexer;
	}
	...
	private AstLexer getLexer80(Reader reader) throws IOException {
		final org.eclipse.php.internal.core.ast.scanner.php80.PHPAstLexer phpAstLexer = new org.eclipse.php.internal.core.ast.scanner.php80.PHPAstLexer(
				reader);
		phpAstLexer.setAST(this);
		return phpAstLexer;
	}
	...
	private lr_parser getParserInstance(PHPVersion phpVersion, Scanner lexer) {
		if (PHPVersion.PHP5 == phpVersion) {
			...
			final org.eclipse.php.internal.core.ast.scanner.php80.PHPAstParser parser = new org.eclipse.php.internal.core.ast.scanner.php80.PHPAstParser(
					lexer);
			parser.setAST(this);
			return parser;
		} else if (PHPVersion.PHP8_1 == phpVersion) {
