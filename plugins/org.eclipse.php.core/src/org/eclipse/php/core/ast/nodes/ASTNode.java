...
public abstract class ASTNode implements Visitable {
	 ...
	 */
	private static final Map<Object, Object> UNMODIFIABLE_EMPTY_MAP = Collections.unmodifiableMap(new HashMap<>(1));
	...
	public final void setProperty(String propertyName, Object data) {
		...
		if (this.property1 instanceof String) {
			...
			HashMap<Object, Object> m = new HashMap<>(2);
	...
	public final Map<Object, Object> properties() {
		...
		return (Map<Object, Object>) this.property2;
	}
