...
public class ReflectionConstantAccess extends StaticDispatch {
	...
	public static final ChildPropertyDescriptor CLASS_NAME_PROPERTY = new ChildPropertyDescriptor(
			ReflectionConstantAccess.class, "className", Expression.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
	public static final ChildPropertyDescriptor CONSTANT_PROPERTY = new ChildPropertyDescriptor(
			ReflectionConstantAccess.class, "parameterType", Expression.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
	...
	public void toString(StringBuilder buffer, String tab) {
		buffer.append(tab).append("<ReflectionConstantAccess"); //$NON-NLS-1$
	...
	@Override
	public int getType() {
		return ASTNode.REFLECTION_CONSTANT_ACCESS;
	}
	...
	ASTNode clone0(AST target) {
		...
		final Expression constant = ASTNode.copySubtree(target, getConstant());
		final ReflectionConstantAccess result = new ReflectionConstantAccess(getStart(), getEnd(), target, className,
				constant);
		return result;
	}
