...
public class PHPModelUtils {
	 ...
	 */
	public static IMethod[] getTypeHierarchyMethod(IType type, String name,
	 ...
	 * @param monitor
	 *            Progress monitor
	 * @return method phpdoc element or <code>null</code> in case it couldn't be
	 *         found
	 * @throws CoreException
	 */
	 ...
	 * @throws CoreException
	 */
	public static IField[] getTypeHierarchyField(IType type, String name,
			IProgressMonitor monitor) throws CoreException {
		if (name == null) {
			throw new NullPointerException();
		}
	 ...
	 * @param monitor
	 *            Progress monitor
	 * @return field phpdoc element or <code>null</code> in case it couldn't be
	 *         found
	 * @throws CoreException
	 */
	 ...
	 */
	public static IField getTypeField(IType type, String elementName)
			throws ModelException {
	 ...
	 * @throws ModelException
	 */
	public static IMethod getTypeMethod(IType type, String elementName)
			throws ModelException {
	 ...
	 * @throws ModelException
	 */
	public static IType getTypeType(IType type, String elementName)
			throws ModelException {
	...
	public static IType[] getTypes(String typeName, ISourceModule sourceModule,
		...
		if (namespace != null) {
			if (namespace.length() > 0) {
				IType namespaceType = getNamespaceType(namespace, typeName,
						sourceModule);
	...
	public static IMethod[] getFunctions(String functionName,
			ISourceModule sourceModule, int offset) throws ModelException {
		...
		if (namespace != null) {
			if (namespace.length() > 0) {
				IMethod namespaceMethod = getNamespaceFunction(namespace,
						functionName, sourceModule);
	...
	public static IField[] getFields(String fieldName,
		...
		if (!fieldName.startsWith("$")) { // variables are not supported by
			...
			if (namespace != null) {
				if (namespace.length() > 0) {
					IField namespaceField = getNamespaceField(namespace,
	 ...
	 * @throws ModelException
	 */
	public static IType getNamespaceType(String namespace, String typeName,
	 ...
	 * @return function declarated in the specified namespace, or null if there
	 *         is none
	 * @throws ModelException
	 */
	public static IMethod getNamespaceFunction(String namespace,
			String functionName, ISourceModule sourceModule)
			throws ModelException {
	 ...
	 * @throws ModelException
	 */
	public static IField getNamespaceField(String namespace, String fieldName,
			ISourceModule sourceModule) throws ModelException {
