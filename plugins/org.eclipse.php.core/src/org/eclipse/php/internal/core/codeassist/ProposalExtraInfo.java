...
public final class ProposalExtraInfo {
	...
	public static final int IMPORT_PARENT = 1 << 17;
	...
	public static boolean isImportParent(Object flags) {
		if (flags instanceof Integer) {
			return isImportParent(((Integer) flags).intValue());
		} else {
			return false;
		}
	}

	public static boolean isImportParent(int flags) {
		return (flags & IMPORT_PARENT) != 0;
	}
