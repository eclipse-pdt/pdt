...
public class PostfixExpression extends Expression {
	...
	public static final ChildPropertyDescriptor VARIABLE_PROPERTY = 
		new ChildPropertyDescriptor(PostfixExpression.class, "variable", VariableBase.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
	public static final SimplePropertyDescriptor OPERATOR_PROPERTY = 
		new SimplePropertyDescriptor(PostfixExpression.class, "operator", Integer.class, MANDATORY); //$NON-NLS-1$
