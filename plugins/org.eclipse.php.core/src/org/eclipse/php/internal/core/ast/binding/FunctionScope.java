 ...
 * Description:   
 */
public class FunctionScope extends ScopeBase {

	private FunctionScope childScope;
	private FunctionScope parentScope;

	public FunctionScope(int start, ProgramScope programScope) {
	...
	public ScopeType getScopeType() {
		return ScopeType.FUNCTION_SCOPE;
	}
