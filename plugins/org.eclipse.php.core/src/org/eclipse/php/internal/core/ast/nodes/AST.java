...
public class AST {
	...
	/**
	 * Creates a new {@link YieldStatement}.
	 * 
	 * @return A new YieldStatement.
	 */
	public YieldStatement newYieldStatement() {
		YieldStatement yieldStatement = new YieldStatement(this);
	 ...
	 * @return A new YieldStatement.
	 */
	public YieldStatement newYieldStatement(Expression expression) {
		YieldStatement yieldStatement = new YieldStatement(this);
		yieldStatement.setExpression(expression);
		return yieldStatement;
	}
