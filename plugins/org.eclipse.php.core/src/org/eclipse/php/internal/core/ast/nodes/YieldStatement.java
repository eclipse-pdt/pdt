...
public class YieldStatement extends Statement {
	...
	public YieldStatement(int start, int end, AST ast) {
	...
	public YieldStatement(int start, int end, AST ast, Expression expr) {
		super(start, end, ast);
	...
	public void toString(StringBuffer buffer, String tab) {
		buffer.append(tab).append("<YieldStatement"); //$NON-NLS-1$
	...
	ASTNode clone0(AST target) {
		...
		final YieldStatement result = new YieldStatement(this.getStart(),
