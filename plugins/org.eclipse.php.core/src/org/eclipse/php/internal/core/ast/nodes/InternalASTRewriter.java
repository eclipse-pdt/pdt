...
import org.eclipse.php.internal.core.ast.rewrite.ListRewriteEvent;
import org.eclipse.php.internal.core.ast.rewrite.NodeInfoStore;
import org.eclipse.php.internal.core.ast.rewrite.NodeRewriteEvent;
...
class InternalASTRewrite extends NodeEventHandler {
	...
	public TextEdit rewriteAST(IDocument document, Map options) {
		...
		if (rootNode != null) {
			...
			// TODO: write our ASTRewriteAnalayzer
