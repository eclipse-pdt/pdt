...
public abstract class PHPASTVisitor extends ASTVisitor {
	...
	public boolean endvisit(ASTNode s) throws Exception {
		...
		if (s instanceof FormalParameterByReference) {
		...
		if (s instanceof ListVariable) {
			return endvisit((ListVariable) s);
		}
		if (s instanceof PHPCallArgumentsList) {
			return endvisit((PHPCallArgumentsList) s);
		}
		if (s instanceof PHPCallExpression) {
		...
		if (s instanceof PostfixExpression) {
		...
		if (s instanceof Quote) {
			return endvisit((Quote) s);
		}
		if (s instanceof ReferenceExpression) {
			return endvisit((ReferenceExpression) s);
		}
		if (s instanceof ReflectionArrayVariableReference) {
			return endvisit((ReflectionArrayVariableReference) s);
		}
		if (s instanceof ReflectionCallExpression) {
			return endvisit((ReflectionCallExpression) s);
		}
		if (s instanceof ReflectionStaticMethodInvocation) {
			return endvisit((ReflectionStaticMethodInvocation) s);
		}
		if (s instanceof ReflectionVariableReference) {
		...
		if (s instanceof StaticConstantAccess) {
			return endvisit((StaticConstantAccess) s);
		}
		if (s instanceof StaticDispatch) {
			return endvisit((StaticDispatch) s);
		}
		if (s instanceof StaticFieldAccess) {
			return endvisit((StaticFieldAccess) s);
		}
		if (s instanceof StaticMethodInvocation) {
			return endvisit((StaticMethodInvocation) s);
		}
		if (s instanceof StaticStatement) {
		...
		if (s instanceof TypeReference) {
			return endvisit((TypeReference) s);
		}
		if (s instanceof UnaryOperation) {
		...
		if (s instanceof SimpleReference) {
