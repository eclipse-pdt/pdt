...
public class PHP5LanguageModel extends PHPLanguageModel {
	...
	private void initKeywords() {
		keyword = new PHPKeywordData[] { PHPCodeDataFactory.createPHPKeywordData("exit", "()", 1), PHPCodeDataFactory.createPHPKeywordData("die", "()", 1), PHPCodeDataFactory.createPHPKeywordData("function", " ", 1), PHPCodeDataFactory.createPHPKeywordData("const", " ", 1),
			...
			PHPCodeDataFactory.createPHPKeywordData("new", " ", 1), PHPCodeDataFactory.createPHPKeywordData("var", " ", 1), PHPCodeDataFactory.createPHPKeywordData("eval", "()", 1), PHPCodeDataFactory.createPHPKeywordData("include", " '';", 2),
			PHPCodeDataFactory.createPHPKeywordData("include_once", " '';", 2), PHPCodeDataFactory.createPHPKeywordData("require", " '';", 2), PHPCodeDataFactory.createPHPKeywordData("require_once", " '';", 2), PHPCodeDataFactory.createPHPKeywordData("global", " ", 1),
