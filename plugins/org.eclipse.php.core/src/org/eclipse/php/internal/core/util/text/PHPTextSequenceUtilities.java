...
public class PHPTextSequenceUtilities {
	...
	public static boolean isCommentRegion(String regionType) {
		return regionType == PHPRegionTypes.PHP_COMMENT
				|| regionType == PHPRegionTypes.PHP_COMMENT_START
				|| regionType == PHPRegionTypes.PHP_COMMENT_END
				|| regionType == PHPRegionTypes.PHPDOC_COMMENT
				|| regionType == PHPRegionTypes.PHPDOC_COMMENT_START
				|| regionType == PHPRegionTypes.PHPDOC_COMMENT_END
				|| regionType == PHPRegionTypes.PHP_LINE_COMMENT;
	}
	...
	public static int readForwardSpaces(IDocument document, int startPosition,
			int endPosition) throws BadLocationException {
		int rv = startPosition;
