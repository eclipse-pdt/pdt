 ...
 *     Zend Technologies
 *******************************************************************************/
package org.eclipse.php.internal.core.compiler.ast.parser.php85;
...
import org.eclipse.php.internal.core.ast.scanner.php84.ParserConstants;
import org.eclipse.php.internal.core.compiler.ast.parser.ASTUtils;
import org.eclipse.php.internal.core.compiler.ast.parser.DocumentorLexer;

import java_cup.runtime.Symbol;

public class CompilerAstLexer extends org.eclipse.php.internal.core.ast.scanner.php85.PHPAstLexer {
	...
	protected Symbol createFullSymbol(int symbolNumber) {
		...
		case ParserConstants.T_ATTRIBUTE:
		case ParserConstants.T_PUBLIC_SET:
		case ParserConstants.T_PRIVATE_SET:
		case ParserConstants.T_PROTECTED_SET:
