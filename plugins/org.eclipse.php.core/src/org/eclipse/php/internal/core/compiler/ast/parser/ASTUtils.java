...
public class ASTUtils {
	...
	/**
	 * Creates fake FQN that combines use statement namespace and use part
	 * namespace. Used to create a fake FullyQualifiedReference object that
	 * combines use statement namespace and use part namespace of a group use
	 * statement. For example, this method will return an object for type
