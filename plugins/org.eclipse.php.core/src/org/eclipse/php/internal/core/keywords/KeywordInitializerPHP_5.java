...
public class KeywordInitializerPHP_5 extends KeywordInitializerPHP_4 {
	...
	public void initialize(Collection<KeywordData> list) {
		...
		list.add(new KeywordData("private", WHITESPACE_SUFFIX, 1, true));
		list.add(new KeywordData("protected", WHITESPACE_SUFFIX, 1, true));
		list.add(new KeywordData("public", WHITESPACE_SUFFIX, 1, true));
