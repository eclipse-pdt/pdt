...
import org.eclipse.php.internal.core.organize.DocumentUtils;
import org.eclipse.php.internal.core.organize.OrganizeProblemIdentifier;
	...
	private static class OrganizeBuildParticipantParticipant
		...
		public void build(IBuildContext context) throws CoreException {
			...
			if (moduleDeclaration != null) {
				...
				try {
					moduleDeclaration
							.traverse(new ImportValidationVisitor(context));
				} catch (Exception e) {
				}
			}
		}
		...
		public boolean visit(UseStatement s) throws Exception {
			...
			for (UsePart part : s.getParts()) {
				...
				DefaultProblem problem = new DefaultProblem(
						...
						OrganizeProblemIdentifier.USE_STATEMENTS, new String[0],
