...
public class KeywordInitializerPHP_5 extends KeywordInitializerPHP_4 {
	...
	public void initialize(Collection<KeywordData> list) {
		...
		list.add(new KeywordData("abstract", WHITESPACE_SUFFIX, 1, PHPKeywords.CLASS_BODY | PHPKeywords.GLOBAL));
		list.add(new KeywordData("catch", WHITESPACE_PARENTESES_SUFFIX, 2));
		list.add(new KeywordData("clone", WHITESPACE_SUFFIX, 1));
		list.add(new KeywordData("final", WHITESPACE_SUFFIX, 1, PHPKeywords.CLASS_BODY | PHPKeywords.GLOBAL));
		...
		list.add(new KeywordData("private", WHITESPACE_SUFFIX, 1, PHPKeywords.CLASS_BODY));
		list.add(new KeywordData("protected", WHITESPACE_SUFFIX, 1, PHPKeywords.CLASS_BODY));
		list.add(new KeywordData("public", WHITESPACE_SUFFIX, 1, PHPKeywords.CLASS_BODY));
