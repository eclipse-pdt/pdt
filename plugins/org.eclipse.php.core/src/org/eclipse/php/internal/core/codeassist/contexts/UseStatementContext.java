...
public abstract class UseStatementContext extends StatementContext {
	...
	public boolean isAbsolute() {
		// when current statement is not a trait:
		// isAbsolute() will return true and isAbsoluteName() will return false,
		// which means that names are always absolute and without leading '\'
