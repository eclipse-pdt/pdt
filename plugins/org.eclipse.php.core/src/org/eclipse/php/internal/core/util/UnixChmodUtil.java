...
public class UnixChmodUtil {
     ...
     * @param int permissions mode (use bitwise <code>|</code> to designate different modes).
     * @return boolean <code>true</code> if succeeded changing permissions, <code>false</code> otherwise.
     */
