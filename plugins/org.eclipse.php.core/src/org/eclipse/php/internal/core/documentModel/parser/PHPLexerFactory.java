...
public class PHPLexerFactory {
	...
	public static AbstractPHPLexer createLexer(Reader reader, PHPVersion phpVersion) {
		...
		if (phpVersion == PHPVersion.PHP8_4) {
			return new org.eclipse.php.internal.core.documentModel.parser.php84.PHPLexer(reader);
		}
		if (phpVersion == PHPVersion.PHP8_5) {
			return new org.eclipse.php.internal.core.documentModel.parser.php85.PHPLexer(reader);
		}
		if (phpVersion == null) {
