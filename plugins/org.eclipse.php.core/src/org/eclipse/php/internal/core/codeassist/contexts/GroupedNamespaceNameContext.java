...
/**
 * This context represents the state when staying inside a grouped use statement
 * in a namespace name part. <br/>
 * Examples:
 * 
 * <pre>
 *  use A\{B, \C\D|};
 ...
 * @author blind
 */
public class GroupedNamespaceNameContext extends UseStatementContext {
