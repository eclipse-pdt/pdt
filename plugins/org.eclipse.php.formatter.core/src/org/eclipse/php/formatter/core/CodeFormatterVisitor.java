...
public class CodeFormatterVisitor extends AbstractVisitor implements ICodeFormattingProcessor {
	...
	public void indentInfixOperand(Expression inFixOperand) {
	...
	public boolean visit(InfixExpression infixExpression) {
		...
		if (infixExpression == binaryExpressionSavedNode) {
			indentInfixOperand(infixExpression.getLeft());

			if (wasBinaryExpressionWrapped
					&& (isStringOperator || this.preferences.insert_space_after_binary_operation)) {
				insertSpace();
			}
		}
		...
		indentInfixOperand(infixExpression.getRight());
