...
public class ServerTab extends AbstractLaunchConfigurationTab {
	...
	protected static final String CUSTOM_URL = "custom_url";
	...
	public void createURLControl(Composite composite) {
		...
		autoGeneratedURL.setText("Auto Generated URL");
		...
		gridData = new GridData(GridData.FILL_HORIZONTAL);
		openBrowser.setLayoutData(gridData);
	...
	protected void createFileComponent(Composite parent) {
		...
		fContextLabel = new Label(group, SWT.NONE);
		fContextLabel.setText("Publish Context Root: ");
		gd = new GridData();
		gd.horizontalSpan = 1;
		gd.horizontalIndent = 20;
		fContextLabel.setLayoutData(gd);

		fPublishContextRoot = new Text(group, SWT.SINGLE | SWT.BORDER);
		gd = new GridData(GridData.FILL_HORIZONTAL);
		gd.horizontalSpan = 2;
		fPublishContextRoot.setLayoutData(gd);
		fPublishContextRoot.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				updateLaunchConfigurationDialog();
				if (autoGeneratedURL.getSelection()) {
					initializeURLControl();
	...
	protected void handleFileButtonSelected() {
		...
		fURL.setText(computeURL(fPublishContextRoot.getText(), fName));
	}
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			...
			boolean isCustomURL = configuration.getAttribute(CUSTOM_URL, true);
	 ...
	 * @return
	 */
	protected String computeURL(String contextRoot, String fileName) {
		if (server == null) {
			return "";
		}
	...
	protected void initializeURLControl() {
		if (fPublishContextRoot == null || fFile == null) {
			return;
		}
		fURL.setText(computeURL(fPublishContextRoot.getText(), fFile.getText()));
